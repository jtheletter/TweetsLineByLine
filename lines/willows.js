module.exports = ['THE WIND IN THE WILLOWS','By KENNETH GRAHAME',
...
'When the floods are on in February, and my cellars and basement are brimming with drink that’s no good to me, and the brown water runs by my best bedroom window;',
'or again when it all drops away and, shows patches of mud that smells like plum-cake, and the rushes and weed clog the channels, and I can potter about dry shod over most of the bed of it and find fresh food to eat, and things careless people have dropped out of boats!”',
...
'Green turf sloped down to either edge, brown snaky tree-roots gleamed below the surface of the quiet water,',
'while ahead of them the silvery shoulder and foamy tumble of a weir, arm-in-arm with a restless dripping mill-wheel, that held up in its turn a grey-gabled mill-house, filled the air with a soothing murmur of sound, dull and smothery,',
...
'while his excited friend shook out the table-cloth and spread it, took out all the mysterious packets one by one and arranged their contents in due order, still gasping, “O my! O my!” at each fresh revelation.',
'When all was ready, the Rat said, “Now, pitch in, old fellow!” and the Mole was indeed very glad to obey, for he had started his spring-cleaning at a very early hour that morning, as people will do, and had not paused for bite or sup;',
...
'and last of all, behold! the mustard pot, which he had been sitting on without knowing it—still, somehow, the thing got finished at last, without much loss of temper.',
...
'But the Mole was very full of lunch, and self-satisfaction, and pride, and already quite at home in a boat (so he thought) and was getting a bit restless besides:',
'and presently he said, “Ratty! Please, I want to row, now!”',
'The Rat shook his head with a smile.',
'“Not yet, my young friend,” he said—“wait till you’ve had a few lessons. It’s not so easy as it looks.”',
...
'He jumped up and seized the sculls, so suddenly, that the Rat, who was gazing out over the water and saying more poetry-things to himself, was taken by surprise and fell backwards off his seat with his legs in the air for the second time,',
...
'When the Rat had rubbed him down a bit, and wrung some of the wet out of him, he said, “Now, then, old fellow!',
'Trot up and down the towing-path as hard as you can, till you’re warm and dry again, while I dive for the luncheon-basket.”',
'So the dismal Mole, wet without and ashamed within, trotted about till he was fairly dry,',
'while the Rat plunged into the water again, recovered the boat, righted her and made her fast, fetched his floating property to shore by degrees, and finally dived successfully for the luncheon-basket and struggled to land with it.',
...
'Stories about weirs, and sudden floods, and leaping pike, and steamers that flung hard bottles—at least bottles were certainly flung, and from steamers, so presumably by them;',
'and about herons, and how particular they were whom they spoke to;',
'and about adventures down drains, and night-fishings with Otter, or excursions far a-field with Badger.',
...
'And when the ducks stood on their heads suddenly, as ducks will, he would dive down and tickle their necks, just under where their chins would be if ducks had chins,',
'till they were forced to come to the surface again in a hurry, spluttering and angry and shaking their feathers at him, for it is impossible to say quite all you feel when your head is under water.',
...
'So the Mole and Rat turned to, quietly and manfully, and while the Rat saw to the horse, and lit a fire, and cleaned last night’s cups and platters, and got things ready for breakfast,',
'the Mole trudged off to the nearest village, a long way off, for milk and eggs and various necessaries the Toad had, of course, forgotten to provide.',
...
'the Toad and the Water Rat walking behind the cart talking together—at least Toad was talking, and Rat was saying at intervals, “Yes, precisely; and what did you say to him?”—and thinking all the time of something very different,',
...
'and the magnificent motor-car, immense, breath-snatching, passionate, with its pilot tense and hugging his wheel,',
'possessed all earth and air for the fraction of a second, flung an enveloping cloud of dust that blinded and enwrapped them utterly, and then dwindled to a speck in the far distance, changed back into a droning bee once more.',
...
'“You villains!” he shouted, shaking both fists, “You scoundrels, you highwaymen, you—you—roadhogs!—I’ll have the law of you!',
'I’ll report you!',
'I’ll take you through all the Courts!”',
'His home-sickness had quite slipped away from him, and for the moment he was the skipper of the canary-coloured vessel driven on a shoal by the reckless jockeying of rival mariners,',
'and he was trying to recollect all the fine and biting things he used to say to masters of steam-launches when their wash, as they drove too near the bank, used to flood his parlour-carpet at home.',
...
'But the Badger never came along, and every day brought its amusements,',
'and it was not till summer was long over, and cold and frost and miry ways kept them much indoors, and the swollen river raced past outside their windows with a speed that mocked at boating of any sort or kind,',
'that he found his thoughts dwelling again with much persistence on the solitary grey Badger, who lived his own life by himself, in his hole in the middle of the Wild Wood.',
...
'still, the Mole had a good deal of spare time on his hands, and so one afternoon, when the Rat in his arm-chair before the blaze was alternately dozing and trying over rhymes that wouldn’t fit,',
...
'Copses, dells, quarries and all hidden places, which had been mysterious mines for exploration in leafy summer, now exposed themselves and their secrets pathetically,',
'and seemed to ask him to overlook their shabby poverty for a while, till they could riot in rich masquerade as before, and trick and entice him with the old deceptions.',
...
'And as he lay there panting and trembling, and listened to the whistlings and the patterings outside,',
...
'He made his way manfully through the length of the wood, to its furthest edge; then, forsaking all paths, he set himself to traverse it, laboriously working over the whole ground, and all the time calling out cheerfully, “Moly, Moly, Moly!',
'Where are you?',
...
'However, they set out bravely, and took the line that seemed most promising, holding on to each other and pretending with invincible cheerfulness that they recognized an old friend in every fresh tree that grimly and silently greeted them,',
'or saw openings, gaps, or paths with a familiar turn in them, in the monotony of white space and black tree-trunks that refused to vary.',
...
'really it seemed only a question of what they should attack first where all was so attractive, and whether the other things would obligingly wait for them till they had time to give them attention.',
...
'The fact is, as already set forth, when you live a life of intense activity for six months in the year, and of comparative or actual somnolence for the other six,',
...
'At any rate, I had learnt something; and if I had had the luck to meet any of ‘Them’ I’d have learnt something more—or they would.”',
...
'So the good-natured Mole, having cut some slices of ham, set the hedgehogs to fry it, and returned to his own breakfast,',
...
'As he hurried along, eagerly anticipating the moment when he would be at home again among the things he knew and liked,',
'the Mole saw clearly that he was an animal of tilled field and hedge-row, linked to the ploughed furrow, the frequented pasture, the lane of evening lingerings, the cultivated garden-plot.',
...
'as the two animals hastened by in high spirits, with much chatter and laughter.',
...
'and to the lookers-in from outside, the inmates, gathered round the tea-table, absorbed in handiwork, or talking with laughter and gesture, had each that happy grace which is the last thing the skilled actor shall capture—',
'the natural grace which goes with perfect unconsciousness of observation.',
'Moving at will from one theatre to another, the two spectators, so far from home themselves,',
'had something of wistfulness in their eyes as they watched a cat being stroked, a sleepy child picked up and huddled off to bed, or a tired man stretch and knock out his pipe on the end of a smouldering log.',
...
'We others, who have long lost the more subtle of the physical senses, have not even proper terms to express an animal’s inter-communications with his surroundings, living or otherwise,',
'and have only the word “smell,” for instance, to include the whole range of delicate thrills which murmur in the nose of the animal night and day, summoning, warning, inciting, repelling.',
...
'and I went away and forgot all about it—and then I smelt it suddenly—on the road, when I called and you wouldn’t listen, Rat—and everything came back to me with a rush—and I wanted it!—O dear, O dear!—',
...
'When at last it seemed to the Rat that they must be nearing that part of the road where the Mole had been “held up,” he said, “Now, no more talking.',
'Business!',
...
'the Mole, his bosom still heaving with the stress of his recent emotion, related—somewhat shyly at first, but with more freedom as he warmed to his subject—',
'how this was planned, and how that was thought out, and how this was got through a windfall from an aunt, and that was a wonderful find and a bargain, and this other thing was bought out of laborious savings and a certain amount of “going without.”',
...
'At last the Rat succeeded in decoying him to the table, and had just got seriously to work with the sardine-opener when sounds were heard from the fore-court without—',
...
'and forthwith their shrill little voices uprose on the air, singing one of the old-time carols that their forefathers composed in fields that were fallow and held by frost, or when snow-bound in chimney corners,',
...
'Here much muttered conversation ensued, and the Mole only heard bits of it, such as—',
'“Fresh, mind!—no, a pound of that will do—see you get Buggins’s, for I won’t have any other—no, only the best—if you can’t get it there, try somewhere else—yes, of course, home-made, no tinned stuff—well then, do the best you can!”',
...
'while the Mole, failing to draw them into easy conversation, plunged into family history and made each of them recite the names of his numerous brothers,',
'who were too young, it appeared, to be allowed to go out a-carolling this year, but looked forward very shortly to winning the parental consent.',
...
'When his violent paroxysms possessed him he would arrange bedroom chairs in rude resemblance of a motor-car and would crouch on the foremost of them, bent forward and staring fixedly ahead, making uncouth and ghastly noises,',
'till the climax was reached, when, turning a complete somersault, he would lie prostrate amidst the ruins of the chairs, apparently completely satisfied for the moment.',
...
'If only I had done something!’ But no; it’s a trouble.',
...
'Then, laughing heartily, he dressed as quickly as possible in the smartest suit he could lay hands on at the moment, filled his pockets with cash which he took from a small drawer in the dressing-table,',
'and next, knotting the sheets from his bed together and tying one end of the improvised rope round the central mullion of the handsome Tudor window which formed such a feature of his bedroom, he scrambled out, slid lightly to the ground,',
'and, taking the opposite direction to the Rat, marched off lightheartedly, whistling a merry tune.',
...
'Filled full of conceited thoughts such as these he strode along, his head in the air, till he reached a little town,',
'where the sign of “The Red Lion,” swinging across the road halfway down the main street, reminded him that he had not breakfasted that day, and that he was exceedingly hungry after his long walk.',
...
'He increased his pace, and as the car devoured the street and leapt forth on the high road through the open country, he was only conscious that he was Toad once more,',
...
'“the only difficulty that presents itself in this otherwise very clear case is, how we can possibly make it sufficiently hot for the incorrigible rogue and hardened ruffian whom we see cowering in the dock before us.',
...
'and fifteen years for the cheek, which was pretty bad sort of cheek, judging by what we’ve heard from the witness-box, even if you only believe one-tenth part of what you heard, and I never believe more myself—',
...
'across the hollow-sounding drawbridge, below the spiky portcullis, under the frowning archway of the grim old castle, whose ancient towers soared high overhead;',
'past guardrooms full of grinning soldiery off duty, past sentries who coughed in a horrid, sarcastic way, because that is as much as a sentry on his post dare do to show his contempt and abhorrence of crime;',
'up time-worn winding stairs, past men-at-arms in casquet and corselet of steel, darting threatening looks through their vizards;',
'across courtyards, where mastiffs strained at their leash and pawed the air to get at him;',
'past ancient warders, their halberds leant against the wall, dozing over a pasty and a flagon of brown ale;',
'on and on, past the rack-chamber and the thumbscrew-room, past the turning that led to the private scaffold, till they reached the door of the grimmest dungeon that lay in the heart of the innermost keep.',
...
'Dark and deserted as it was, the night was full of small noises, song and chatter and rustling,',
'telling of the busy little population who were up and about, plying their trades and vocations through the night till sunshine should fall on them at last and send them off to their well-earned repose.',
...
'the great weir closed the backwater from bank to bank, troubled all the quiet surface with twirling eddies and floating foam-streaks, and deadened all other sounds with its solemn and soothing rumble.',
...
'As a child that has fallen happily asleep in its nurse’s arms, and wakes to find itself alone and laid in a strange place, and searches corners and cupboards, and runs from room to room, despair growing silently in its heart,',
'even so Portly searched the island and searched, dogged and unwearying, till at last the black moment came for giving it up, and sitting down and crying bitterly.',
...
'The sun was fully up by now, and hot on them, birds sang lustily and without restraint, and flowers smiled and nodded from either bank,',
...
'and knew that all the grim darkness of a medieval fortress lay between him and the outer world of sunshine and well-metalled high roads where he had lately been so happy, disporting himself as if he had bought up every road in England,',
'he flung himself at full length on the floor, and shed bitter tears, and abandoned himself to dark despair.',
...
'With lamentations such as these he passed his days and nights for several weeks, refusing his meals or intermediate light refreshments,',
'though the grim and ancient gaoler, knowing that Toad’s pockets were well lined, frequently pointed out that many comforts, and indeed luxuries, could by arrangement be sent in—at a price—from outside.',
...
'She was particularly fond of animals, and, besides her canary, whose cage hung on a nail in the massive wall of the keep by day, to the great annoyance of prisoners who relished an after-dinner nap, and was shrouded in an antimacassar on the parlour table at night,',
...
'So the wise girl retired for the time, but, of course, a good deal of the smell of hot cabbage remained behind, as it will do, and Toad, between his sobs, sniffed and reflected, and gradually began to think new and inspiring thoughts:',
'of chivalry, and poetry, and deeds still to be done;',
...
'When the girl returned, some hours later, she carried a tray, with a cup of fragrant tea steaming on it;',
'and a plate piled up with very hot buttered toast, cut thick, very brown on both sides, with the butter running through the holes in it in great golden drops, like honey from the honeycomb.',
...
'and Toad, pitching into the toast with avidity, his spirits quite restored to their usual level, told her about the boathouse, and the fish-pond, and the old walled kitchen-garden;',
'and about the pig-styes, and the stables, and the pigeon-house, and the hen-house;',
'and about the dairy, and the wash-house, and the china-cupboards, and the linen-presses (she liked that bit especially);',
'and about the banqueting-hall, and the fun they had there when the other animals were gathered round the table and Toad was at his best, singing songs, telling stories, carrying on generally.',
...
'The chaff and the humourous sallies to which he was subjected, and to which, of course, he had to provide prompt and effective reply, formed, indeed, his chief danger;',
...
'Dizzy with the easy success of his daring exploit, he walked quickly towards the lights of the town,',
'not knowing in the least what he should do next, only quite certain of one thing, that he must remove himself as quickly as possible from the neighbourhood where the lady he was forced to represent was so well-known and so popular a character.',
...
'To his horror he recollected that he had left both coat and waistcoat behind him in his cell, and with them his pocket-book, money, keys, watch, matches, pencil-case—',
'all that makes life worth living, all that distinguishes the many-pocketed animal, the lord of creation, from the inferior one-pocketed or no-pocketed productions that hop or trip about permissively, unequipped for the real contest.',
'In his misery he made one desperate effort to carry the thing off, and, with a return to his fine old manner—a blend of the Squire and the College Don—he said, “Look here!',
...
'“And they’ll be hungry—and playing with matches—and upsetting lamps, the little innocents!—and quarrelling, and going on generally. O dear, O dear!”',
...
'As the speed increased, and the Toad could see on either side of him real fields, and trees, and hedges, and cows, and horses, all flying past him,',
'and as he thought how every minute was bringing him nearer to Toad Hall, and sympathetic friends, and money to chink in his pocket, and a soft bed to sleep in, and good things to eat, and praise and admiration at the recital of his adventures and his surpassing cleverness,',
'he began to skip up and down and shout and sing snatches of song, to the great astonishment of the engine-driver, who had come across washerwomen before, at long intervals, but never one at all like this.',
...
'policemen in their helmets, waving truncheons;',
'and shabbily dressed men in pot-hats, obvious and unmistakable plain-clothes detectives even at this distance, waving revolvers and walking-sticks;',
...
'and although in the tilled acres green had given way to gold, though rowans were reddening, and the woods were dashed here and there with a tawny fierceness,',
'yet light and warmth and colour were still present in undiminished measure, clean of any chilly premonitions of the passing year.',
...
'Leaving the water-side, where rushes stood thick and tall in a stream that was becoming sluggish and low,',
'he wandered country-wards, crossed a field or two of pasturage already looking dusty and parched, and thrust into the great sea of wheat, yellow, wavy, and murmurous, full of quiet motion and small whisperings.',
...
'and then, you know, the best flats get picked up so quickly nowadays, and if you’re late you have to put up with anything;',
...
'If you’ve got to leave this pleasant place, and your friends who will miss you, and your snug homes that you’ve just settled into,',
'why, when the hour strikes I’ve no doubt you’ll go bravely, and face all the trouble and discomfort and change and newness, and make believe that you’re not very unhappy.',
...
'The mere chatter of these southern-bound birds, their pale and second-hand reports, had yet power to awaken this wild new sensation and thrill him through and through with it;',
'what would one moment of the real thing work in him—one passionate touch of the real southern sun, one waft of the authentic odor?',
...
'Restlessly the Rat wandered off once more, climbed the slope that rose gently from the north bank of the river, and lay looking out towards the great ring of Downs that barred his vision further southwards—',
'his simple horizon hitherto, his Mountains of the Moon, his limit behind which lay nothing he had cared to see or to know.',
...
'Or, when weary of wandering, can sit at the edge of the Grand Canal at night, feasting with his friends,',
'when the air is full of music and the sky full of stars, and the lights flash and shimmer on the polished steel prows of the swaying gondolas, packed so that you could walk across the canal on them from side to side!',
...
'There he got out the luncheon-basket and packed a simple meal, in which, remembering the stranger’s origin and preferences, he took care to include',
'a yard of long French bread, a sausage out of which the garlic sang, some cheese which lay down and cried, and a long-necked straw-covered flask wherein lay bottled sunshine shed and garnered on far Southern slopes.',
...
'The Sea Rat, as soon as his hunger was somewhat assuaged, continued the history of his latest voyage,',
'conducting his simple hearer from port to port of Spain, landing him at Lisbon, Oporto, and Bordeaux, introducing him to the pleasant harbours of Cornwall and Devon,',
'and so up the Channel to that final quayside, where, landing after winds long contrary, storm-driven and weather-beaten, he had caught the first magical hints and heraldings of another Spring,',
'and, fired by these, had sped on a long tramp inland, hungry for the experiment of life on some quiet farmstead, very far from the weary beating of any sea.',
...
'By this time their meal was over, and the Seafarer, refreshed and strengthened, his voice more vibrant, his eye lit with a brightness that seemed caught from some far-away sea-beacon,',
'filled his glass with the red and glowing vintage of the South, and, leaning towards the Water Rat, compelled his gaze and held him, body and soul, while he talked.',
...
'And the talk, the wonderful talk flowed on—or was it speech entirely, or did it pass at times into song—',
'chanty of the sailors weighing the dripping anchor, sonorous hum of the shrouds in a tearing North-Easter, ballad of the fisherman hauling his nets at sundown against an apricot sky, chords of guitar and mandoline from gondola or caique?',
...
'Of deep-sea fishings he heard tell, and mighty silver gatherings of the mile-long net;',
'of sudden perils, noise of breakers on a moonless night, or the tall bows of the great liner taking shape overhead through the fog;',
'of the merry home-coming, the headland rounded, the harbour lights opened out;',
'the groups seen dimly on the quay, the cheery hail, the splash of the hawser;',
...
'the salmon leap on the flood tide, schools of mackerel flash and play past quay-sides and foreshores, and by the windows the great vessels glide, night and day, up to their moorings or forth to the open sea.',
...
'partly by the bright sunlight streaming in on him, partly by the exceeding coldness of his toes,',
'which made him dream that he was at home in bed in his own handsome room with the Tudor window, on a cold winter’s night, and his bedclothes had got up,',
'grumbling and protesting they couldn’t stand the cold any longer, and had run downstairs to the kitchen fire to warm themselves;',
...
'then, with a leap of the heart, remembered everything—his escape, his flight, his pursuit;',
...
'The sun was shining brightly, his wet clothes were quite dry again, he had money in his pocket once more, he was nearing home and friends and safety,',
'and, most and best of all, he had had a substantial meal, hot and nourishing, and felt big, and strong, and careless, and self-confident.',
...
'Ceasing to heed where he was going, he struggled on blindly and wildly, looking back over his shoulder at the now triumphant enemy,',
'when suddenly the earth failed under his feet, he grasped at the air, and, splash! he found himself head over ears in deep water, rapid water, water that bore him along with a force he could not contend with;',
...
'and the water-logged Toad came up slowly but surely over the edge of the hole, till at last he stood safe and sound in the hall,',
'streaked with mud and weed to be sure, and with the water streaming off him,',
'but happy and high-spirited as of old, now that he found himself once more in the house of a friend, and dodgings and evasions were over, and he could lay aside a disguise that was unworthy of his position and wanted such a lot of living up to.',
'“O, Ratty!” he cried.',
...
'“Toad,” said the Water Rat, gravely and firmly,',
...
'for a more shabby, bedraggled, disreputable-looking object than you are I never set eyes on in my whole life!',
...
'and making strange suppressed noises inside him, k-i-ck-ck-ck, and poop-p-p, and other sounds resembling stifled snorts, or the opening of soda-water bottles,',
'yet when the Rat had quite finished, he heaved a deep sigh and said, very nicely and humbly, “Quite right, Ratty!',
...
'The fact is, while I was hanging on to the edge of your hole and getting my breath, I had a sudden idea—a really brilliant idea—connected with motor-boats—there, there! don’t take on so, old chap, and stamp, and upset things;',
'it was only an idea, and we won’t talk any more about it now.',
...
'the garden, a blaze of flowers;',
'the creek that led up to the boat-house, the little wooden bridge that crossed it;',
'all tranquil, uninhabited, apparently waiting for his return.',
...
'“While you were riding about the country in expensive motor-cars, and galloping proudly on blood-horses, and breakfasting on the fat of the land,',
'those two poor devoted animals have been camping out in the open, in every sort of weather, living very rough by day and lying very hard by night;',
...
'Toad was quite alarmed at this very serious and portentous style of greeting; but the Rat whispered to him, “Never mind; don’t take any notice; and don’t say anything to him just yet.',
...
'But he had had a long day, with many events crowded into it;',
...
'“Here’s-a-sword-for-the-Rat, here’s-a-sword-for-the Mole, here’s-a-sword-for-the-Toad, here’s-a-sword-for-the-Badger! Here’s-a-pistol-for-the-Rat, here’s-a-pistol-for-the-Mole, here’s-a-pistol-for-the-Toad, here’s-a-pistol-for-the-Badger!”',
...
'Don’t keep my men idling and talking on their posts.’ ‘Run away?’ says I; ‘it won’t be me that’ll be running away, in a very short time from now!’”',
...
'There won’t be much left of you to wash, by the time they’ve done with you, unless you clear out while you have the chance!’ Then I ran away, and when I was out of sight I hid; and presently I came creeping back along the ditch and took a peep at them through the hedge.',
...
'We all know Toad!”—(great laughter)—“Good Toad, modest Toad, honest Toad!”',
...
'and he would take care to mention the leading part he had taken in the fight, and how he had laid the Chief Weasel flat;',
...
'All the animals cheered when he entered, and crowded round to congratulate him and say nice things about his courage, and his cleverness, and his fighting qualities; but Toad only smiled faintly, and murmured, “Not at all!”',
...
'but Toad, in a mild way, was rather snubby to him, remarking gently, as he disengaged himself, “Badger’s was the mastermind;',
...
'Some of the younger and livelier animals, as the evening wore on, got whispering to each other that things were not so amusing as they used to be in the good old days;',
'and there were some knockings on the table and cries of “Toad! Speech! Speech from Toad! Song! Mr. Toad’s song!”',
'But Toad only shook his head gently, raised one paw in mild protest, and,',
'by pressing delicacies on his guests, by topical small-talk, and by earnest inquiries after members of their families not yet old enough to appear at social functions, managed to convey to them that this dinner was being run on strictly conventional lines.',
...
'and it was pleasing to see how respectfully they were greeted by the inhabitants, and how the mother-weasels would bring their young ones to the mouths of their holes, and say, pointing, “Look, baby!',
