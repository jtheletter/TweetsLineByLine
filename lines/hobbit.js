module.exports = ['THE HOBBIT','Or THERE AND BACK AGAIN',
'By J.R.R. TOLKIEN',
...
'and Bilbo Baggins was standing at his door after breakfast smoking an enormous long wooden pipe that reached nearly down to his woolly toes (neatly brushed)—Gandalf came by.',
'Gandalf!',
...
'Why not tomorrow? Come tomorrow!',
'Good bye!”',
'With that the hobbit turned and scuttled inside his round green door, and shut it as quickly as he dared, not to seem rude.',
...
'in the corner, while the four dwarves sat round the table, and talked about mines and gold and troubles with the goblins, and the depredations of dragons, and lots of other things which he did not understand, and did not want to, for they sounded much too adventurous—',
'when, ding-dong-a-ling-dang, his bell rang again, as if some naughty little hobbit-boy was trying to pull the handle off.',
...
'He had made quite a dent on the beautiful door; he had also, by the way, knocked out the secret mark that he had put there the morning before.',
'“Carefully! Carefully!” he said.',
...
'“Well, your father gave me this to give to you; and if I have chosen my own time and way for handing it over, you can hardly blame me, considering the trouble I had to find you.',
'Your father could not remember his own name when he gave me the paper, and he never told me yours; so on the whole I think I ought to be praised and thanked!',
...
'Your father went away to try his luck with the map after your grandfather was killed; and lots of adventures of a most unpleasant sort he had, but he never got near the Mountain.',
...
'Indeed he was really relieved after all to think that they had all gone without him, and without bothering to wake him up (“but with never a thank-you” he thought); and yet in a way he could not help feeling just a trifle disappointed.',
...
'He had eaten most, talked most, and laughed most.',
...
'There was a hill some way off with trees on it, pretty thick in parts.',
...
'The old maps are no use: things have changed for the worse and the road is unguarded.',
...
'Up the hill they went; but there was no proper path to be seen, such as might lead to a house or a farm; and do what they could they made a deal of rustling and crackling and creaking (and a good deal of grumbling and dratting), as they went through the trees in the pitch dark.',
...
'So, naturally, he got right up to the fire—for fire it was—without disturbing anyone.',
...
'Either he should have gone back quietly and warned his friends that there were three fair-sized trolls at hand in a nasty mood, quite likely to try roasted dwarf, or even pony, for a change; or else he should have done a bit of good quick burgling.',
...
'But his poor little feet had been very squashed in Bert’s big paw, and he had no breath in his body, and his head was going round; so there he lay for a while panting, just outside the circle of firelight.',
...
'“O! are they?” said Thorin, and he jumped forward to the fire, before they could leap on him.',
...
'all neatly tied up in sacks, with three angry trolls (and two with burns and bashes to remember) sitting by them, arguing whether they should roast them slowly, or mince them fine and boil them, or just sit on them one by one and squash them into jelly;',
...
'with patches and slashes of grass-green and moss-green showing where water might be.',
...
'“Hush, hush!',
'Good People! and good night!” said Gandalf, who came last.',
...
'and were hurling rocks at one another for a game, and catching them, and tossing them down into the darkness where they smashed among the trees far below, or splintered into little bits with a bang.',
...
'For, somehow, he could not go to sleep for a long while; and when he did sleep, he had very nasty dreams.',
...
'The ponies were already there huddled in a corner; and there were all the baggages and packages lying broken open, and being rummaged by goblins, and smelt by goblins, and fingered by goblins, and quarrelled over by goblins.',
...
'for wheels and engines and explosions always delighted them, and also not working with their own hands more than they could help;',
...
'Not that it will do you much good, Thorin Oakenshield, I know too much about your folk already; but let’s have the truth, or I will prepare something particularly uncomfortable for you!”',
'“We were on a journey to visit our relatives, our nephews and nieces, and first, second, and third cousins, and the other descendants of our grandfathers, who live on the East side of these truly hospitable mountains,”',
...
'Of course it was Gandalf; but just then they were too busy to ask how he got there.',
...
'Still goblins go faster than dwarves, and these goblins knew the way better (they had made the paths themselves), and were madly angry; so that do what they could the dwarves heard the cries and howls getting closer and closer.',
...
'That is why neither Bilbo, nor the dwarves, nor even Gandalf heard them coming.',
...
'and after all if their holes are nice cheery places and properly aired, quite different from the tunnels of the goblins,',
'still they are more used to tunnelling than we are, and they do not easily lose their sense of direction underground—not when their heads have recovered from being bumped.',
...
'fish whose fathers swam in, goodness only knows how many years ago, and never swam out again, while their eyes grew bigger and bigger and bigger from trying to see in the blackness;',
...
'After a while Gollum began to hiss with pleasure to himself: “Is it nice, my preciousss?',
'Is it juicy?',
...
'He flapped into the water and paddled to the bank; Bilbo could see his eyes coming towards him.',
'His tongue seemed to stick in his mouth; he wanted to shout out:',
...
'“What have you lost?”',
'“It mustn’t ask us,” shrieked Gollum.',
...
'It seemed that the ring he had was a magic ring: it made you invisible!',
...
'and the poor little hobbit dodged this way and that, was knocked over by a goblin who could not make out what he had bumped into, scrambled away on all fours, slipped between the legs of the captain just in time, got up, and ran for the door.',
...
'They could not find Bilbo with the ring on, slipping in and out of the shadow of the trees, running quick and quiet, and keeping out of the sun; so soon they went back grumbling and cursing to guard the door.',
'Bilbo had escaped.',
...
'“And then I couldn’t think of any other question with him sitting beside me,” ended Bilbo; “so I said ‘what’s in my pocket?’ And he couldn’t guess in three goes.',
'So I said: ‘what about your promise?',
...
'“Weren’t there any?”',
'“O yes! lots of them; but I dodged ’em.',
...
'The rest we all know—except that Gandalf knew all about the back-door, as the goblins called the lower gate, where Bilbo lost his buttons.',
...
'“They will be out after us in hundreds when night comes on; and already shadows are lengthening.',
...
'They thought they were friends of the woodmen, and were come to spy on them, and would take news of their plans down into the valleys,',
'and then the goblins and the wolves would have to fight a terrible battle instead of capturing prisoners and devouring people waked suddenly from their sleep.',
...
'He gathered the huge pine-cones from the branches of the tree.',
'Then he set one alight with bright blue fire, and threw it whizzing down among the circle of the wolves.',
...
'Very soon all about the glade wolves were rolling over and over to put out the sparks on their backs,',
'while those that were burning were running about howling and setting others alight,',
'till their own friends chased them away and they fled off down the slopes crying and yammering and looking for water.',
...
'They did not love goblins, or fear them.',
...
'He said it to make them angry, and to show them he was not frightened of them—though of course he was, wizard though he was.',
...
'He just managed to catch hold of Dori’s legs, as Dori was borne off last of all; and up they went together above the tumult and the burning, Bilbo swinging in the air with his arms nearly breaking.',
...
'He used to turn queer if he looked over the edge of quite a little cliff; and he had never liked ladders, let alone trees (never having had to escape from wolves before).',
...
'“No you don’t!” he heard Dori answering, “because the bacon knows that it will get back in the pan sooner or later; and it is to be hoped we shan’t.',
...
'We have no food, and no baggage, and no ponies to ride; and you don’t know where you are.',
...
'We must go and find him; and if all goes well at our meeting, I think I shall be off and wish you like the eagles ‘farewell wherever you fare!’”',
...
'He does not eat them; neither does he hunt or eat wild animals.',
...
'Bilbo bowed.',
'He had no hat to take off, and was painfully conscious of his many missing buttons.',
...
'One bore a white cloth embroidered at the edges with figures of animals; others bore on their broad backs trays with bowls and platters and knives and wooden spoons, which the dogs took and quickly laid on the trestle-tables.',
...
'All the time they ate, Beorn in his deep rolling voice told tales of the wild lands on this side of the mountains,',
'and especially of the dark and dangerous wood, that lay outstretched far to North and South a day’s ride before them, barring their way to the East, the terrible forest of Mirkwood.',
...
'I soon saw that Beorn could not have made them all: there were far too many of them, and they were of various sizes too.',
...
'Beorn was most jolly for a change; indeed he seemed to be in a splendidly good humour and set them all laughing with his funny stories; nor did they have to wonder long where he had been or why he was so nice to them, for he told them himself.',
...
'So much they told him when he forced them, but he guessed there was more wickedness than this afoot,',
'and that a great raid of the whole goblin army with their wolf-allies into the lands shadowed by the mountains might soon be made to find the dwarves, or to take vengeance on the men and creatures that lived there, and who they thought must be sheltering them.',
...
'He would provide ponies for each of them, and a horse for Gandalf, for their journey to the forest, and he would lade them with food to last them for weeks with care, and packed so as to be as easy as possible to carry—',
'nuts, flour, sealed jars of dried fruits, and red earthenware pots of honey, and twice-baked cakes that would keep good a long time, and on a little of which they could march far.',
...
'But if he dared to mention it to Gandalf, the wizard only said: “Hush!',
'Take no notice!”',
...
'Stick to the forest-track, keep your spirits up, hope for the best, and with a tremendous slice of luck you may come out one day and see the Long Marshes lying below you,',
'and beyond them, high in the East, the Lonely Mountain where dear old Smaug lives, though I hope he is not expecting you.”',
...
'Before he had passed quite out of hearing he turned and put his hands to his mouth and called to them.',
'They heard his voice come faintly: “Good-bye!',
...
'There were queer noises too, grunts, scufflings, and hurryings in the undergrowth, and among the leaves that lay piled endlessly thick in places on the forest-floor; but what made the noises he could not see.',
...
'Even the dwarves felt it, who were used to tunnelling, and lived at times for long whiles without the light of the sun; but the hobbit, who liked holes to make a house in but not to spend summer days in, felt that he was being slowly suffocated.',
...
'It is lying on the boat; let’s hope the hook will catch.”',
'It did.',
...
'After that Kili and Oin and Gloin and Dori; next Ori and Nori, Bifur and Bofur; and last Dwalin and Bombur.”',
...
'As soon as they had landed he had bent his bow and fitted an arrow in case any hidden guardian of the boat appeared.',
...
'They were still standing over him, cursing their ill luck, and Bombur’s clumsiness, and lamenting the loss of the boat which made it impossible for them to go back and look for the hart,',
'when they became aware of the dim blowing of horns in the wood and the sound as of dogs baying far off.',
...
'Yet if they had known more about it and considered the meaning of the hunt and the white deer that had appeared upon their path, they would have known that they were at last drawing towards the eastern edge,',
'and would soon have come, if they could have kept up their courage and their hope, to thinner trees and places where the sunlight came again.',
...
'He pushed his way through the tangled twigs with many a slap in the eye; he was greened and grimed from the old bark of the greater boughs; more than once he slipped and caught himself just in time;',
...
'and if Bilbo had had the sense to see it, the tree that he had climbed, though it was tall in itself, was standing near the bottom of a wide valley,',
'so that from its top the trees seemed to swell up all round like the edges of a great bowl, and he could not expect to see how far the forest lasted.',
...
'and next morning when they woke the first thing they noticed was that they were still gnawingly hungry, and the next thing was that it was raining and that here and there the drip of it was dropping heavily on the forest floor.',
...
'We!',
'I only wish it was we: it is horrible being all alone.”',
...
'and even grownup he had still spent a deal of his time at quoits, dart-throwing, shooting at the wand, bowls, ninepins and other quiet games of the aiming and throwing sort—indeed he could do lots of things,',
'besides blowing smoke-rings, asking riddles and cooking, that I haven’t had time to tell you about.',
...
'Good old Bilbo—Bilbo—Bilbo—bo—bo—bo—”',
'And then he fell asleep, and there was complete silence for a long while.',
...
'There they dropped off one by one into uncomfortable sleep full of horrible dreams, as evening wore to black night; and there we must leave them for the present, too sick and weary to set guards or to take turns at watching.',
...
'They got up and staggered on in the direction which eight out of the thirteen of them guessed to be the one in which the path lay; but they never found out if they were right.',
...
'The water flowed dark and swift and strong beneath; and at the far end were gates before the mouth of a huge cave that ran into the side of a steep slope covered with trees.',
...
'He guessed at once, of course, that that was Thorin; and after a while he found that his guess was right.',
...
'until in fact the remarkable Mr. Invisible Baggins (of whom he began to have a very high opinion indeed) had altogether failed to think of something clever.',
...
'But that was no use: probably all the dark distance of Mirkwood lay between them.',
...
'If anyone had come in that way, he would have found himself in a dark rough tunnel leading deep into the heart of the hill; but at one point where it passed under the caves the roof had been cut away and covered with great oaken trapdoors.',
...
'When the barrels were empty the elves cast them through the trapdoors, opened the water-gate, and out the barrels floated on the stream, bobbing along,',
'until they were carried by the current to a place far down the river where the bank jutted out, near to the very eastern edge of Mirkwood.',
...
'Very soon the chief guard had no keys, but Bilbo was trotting as fast as he could along the passages towards the cells.',
...
'and that he was in fact finishing his other business (which does not come into this tale) and getting ready to come in search of Thorin’s company.',
...
'but in the great days of old, when Dale in the North was rich and prosperous, they had been wealthy and powerful, and there had been fleets of boats on the waters, and some were filled with gold and some with warriors in armour,',
'and there had been wars and deeds which were now only a legend.',
...
'These were unpacked and helped ashore where they sat or lay muttering and moaning; they were so soaked and bruised and cramped that they could hardly yet realize their release or be properly thankful for it.',
...
'Poor fat Bombur was asleep or senseless; Dori, Nori, Ori, Oin and Gloin were waterlogged and seemed only half alive; they all had to be carried one by one and laid helpless on the shore.',
...
'Still—all very much at your service once more, Mr. Baggins.',
...
'They packed what they could on the ponies and the rest was made into a store under a tent, but none of the men of the town would stay with them even for the night so near the shadow of the Mountain.',
...
'On this there had been an old watch-post; but they dared not climb it yet, it was too exposed.',
...
'They did not dare to follow the river much further towards the Gate; but they went on beyond the end of the southern spur, until lying hidden behind a rock they could look out and see the dark cavernous opening in a great cliff-wall between the arms of the Mountain.',
...
'In the meanwhile some of them explored the ledge beyond the opening and found a path that led higher and higher on to the mountain; but they did not dare to venture very far that way, nor was there much use in it.',
...
'there was not a doorstep, of course, really,',
'but they used to call the little grassy space between the wall and the opening the “doorstep” in fun,',
'remembering Bilbo’s words long ago at the unexpected party in his hobbit-hole,',
'when he said they could sit on the doorstep till they thought of something.',
'And sit and think they did, or wandered aimlessly about, and glummer and glummer they became.',
'Their spirits had risen a little at the discovery of the path, but now they sank into their boots; and yet they would not give it up and go away.',
...
'over the cliff, over the wide lands to the black wall of Mirkwood, and to the distances beyond,',
...
'Next day the dwarves all went wandering off in various directions; some were exercising the ponies down below, some were roving about the mountain-side.',
...
'Those that were nearest came tumbling over the rocks and as fast as they could along the ledge to him, wondering what on earth was the matter; the others shouted to be hauled up the ropes (except Bombur, of course: he was asleep).',
...
'The most that can be said for the dwarves is this: they intended to pay Bilbo really handsomely for his services;',
'they had brought him to do a nasty job for them, and they did not mind the poor little fellow doing it if he would;',
...
'It was midnight and clouds had covered the stars, but Bilbo lay with his eyes shut, gasping and taking pleasure in the feel of the fresh air again,',
'and hardly noticing the excitement of the dwarves, or how they praised him and patted him on the back and put themselves and all their families for generations to come at his service.',
...
'The tunnel!',
'It’s no good here.”',
'Roused by these words they were just about to creep inside the tunnel when Bifur gave a cry: “My cousins!',
...
'I am Ringwinner and Luckwearer; and I am Barrel-rider,” went on Bilbo beginning to be pleased with his riddling.',
...
'I haven’t been down that way for an age and an age; but I will soon alter that!”',
...
'Perfect! Flawless! Staggering!” exclaimed Bilbo aloud, but what he thought inside was: “Old fool!',
...
'In the meanwhile his friends did their best to cheer him up; and they were eager for his story, especially wanting to know why the dragon had made such an awful noise, and how Bilbo had escaped.',
...
'“I am sure he knows we came from Lake-town and had help from there; and I have a horrible feeling that his next move may be in that direction.',
'I wish to goodness I had never said that about Barrel-rider; it would make even a blind rabbit in these parts think of the Lake-men.”',
'“Well, well!',
...
'He seemed so much in earnest that the dwarves at last did as he said, though they delayed shutting the door—',
...
'which he gave for the arming of his eldest son in a coat of dwarf-linked rings the like of which had never been made before,',
'for it was wrought of pure silver to the power and strength of triple steel.',
...
'“The Arkenstone! The Arkenstone!” murmured Thorin in the dark, half dreaming with his chin upon his knees.',
...
'He was breaking rocks to pieces, smashing wall and cliff with the lashings of his huge tail,',
'till their little lofty camping ground, the scorched grass, the thrush’s stone, the snail-covered walls, the narrow ledge, and all disappeared in a jumble of smithereens,',
'and an avalanche of splintered stones fell over the cliff into the valley below.',
'Smaug had left his lair in silent stealth, quietly soared into the air, and then floated heavy and slow in the dark like a monstrous crow, down the wind towards the west of the Mountain,',
'in the hopes of catching unawares something or somebody there, and of spying the outlet to the passage which the thief had used.',
...
'And I think this time you had better all come with me.”',
...
'Down, down they went.',
'The dwarves could not, of course, compare with the hobbit in real stealth, and they made a deal of puffing and shuffling which echoes magnified alarmingly; but though every now and again Bilbo in fear stopped and listened, not a sound stirred below.',
...
'“Sh! sh!” they hissed, when they heard his voice; and though that helped the hobbit to find out where they were, it was some time before he could get anything else out of them.',
...
'and yet, cut and fashioned by the dwarves, who had dug it from the heart of the mountain long ago, it took all light that fell upon it and changed it into ten thousand sparks of white radiance shot with glints of the rainbow.',
...
'They did say I could pick and choose my own share; and I think I would choose this, if they took all the rest!”',
...
'Someone come and find me and help me!”',
...
'Each now gripped a lighted torch; and as they gazed, first on one side and then on another, they forgot fear and even caution.',
...
'Thorin was not least among these; but always he searched from side to side for something which he could not find.',
...
'Their glittering mail they had covered again with their old cloaks and their bright helms with their tattered hoods,',
'and one by one they walked behind Thorin, a line of little lights in the darkness that halted often, listening in fear once more for any rumour of the dragon’s coming.',
...
'“Come on! Come on!” cried the others.',
...
'The bridge that Balin had spoken of they found long fallen, and most of its stones were now only boulders in the shallow noisy stream; but they forded the water without much difficulty, and found the ancient steps, and climbed the high bank.',
'After going a short way they struck the old road, and before long came to a deep dell sheltered among the rocks; there they rested for a while and had such a breakfast as they could, chiefly cram and water.',
...
'before the roar of Smaug’s terrible approach grew loud, and the lake rippled red as fire beneath the awful beating of his wings.',
...
'Another swoop and another, and another house and then another sprang afire and fell; and still no arrow hindered Smaug or hurt him more than a fly from the marshes.',
...
'three quarters of the people of the town had at least escaped alive; their woods and fields and pastures and cattle and most of their boats remained undamaged; and the dragon was dead.',
...
'At length he spoke again: “This is no time for angry words, Master, or for considering weighty plans of change.',
'There is work to do.',
...
'With the women and the children, the old and the unfit, the Master remained behind; and with him were some men of crafts and many skilled elves; and they busied themselves felling trees, and collecting the timber sent down from the Forest.',
...
'They removed northward higher up the shore; for ever after they had a dread of the water where the dragon lay.',
...
'“Dead! Then we have been in needless fear—and the treasure is ours!”',
...
'At length when he had told all the tale of the battle he went on: “So much for joy, Thorin Oakenshield.',
'You may go back to your halls in safety; all the treasure is yours—for the moment.',
...
'I have spoken.”',
'Then Thorin burst forth in anger: “Our thanks, Roäc Carc’s son.',
...
'They explored the caverns once more, and found, as they expected, that only the Front Gate remained open; all the other gates (except, of course, the small secret door) had long ago been broken and blocked by Smaug, and no sign of them remained.',
...
'for they had food for some weeks with care—chiefly cram, of course, and they were very tired of it;',
...
'“It isn’t exactly; but, well, I am willing to let it stand against all my claim, don’t you know.',
...
'Great weariness began to come over him; but it was well before midnight when he clambered up the rope again—it was still where he had left it.',
...
'But wonder overcame him and he added: “But how came you by the heirloom of my house—if there is need to ask such a question of thieves?”',
...
'“You! You!” cried Thorin, turning upon him and grasping him with both hands.',
...
'“Stay! Your wish is granted!” said a voice.',
...
'“And I will let you go at that—and may we never meet again!”',
...
'It cannot be pierced by arrows; but if you do not hasten, I will sting your miserable feet.',
'So be swift!”',
...
'They halted between the river and the eastern spur; but a few held on their way, and crossing the river drew near the camp; and there they laid down their weapons and held up their hands in sign of peace.',
...
'They meant to push on between the Mountain and the loop of the river; for the narrow land there did not seem to be strongly guarded.',
...
'Behold! the bats are above his army like a sea of locusts.',
...
'Yet this would be perilous, if the goblins were in sufficient numbers to overrun the Mountain itself, and so attack them also from behind and above; but there was no time to make any other plan, or to summon any help.',
...
'“At any rate I am not yet one of the fallen heroes; but I suppose there is still time enough for that!”',
'He sat up painfully.',
...
'It was not long before Bilbo was set down before a tent in Dale; and there stood Gandalf, with his arm in a sling.',
'Even the wizard had not escaped without a wound; and there were few unharmed in all the host.',
...
'Yet even though you were willing to lay aside all your claim, I should wish that the words of Thorin, of which he repented, should not prove true: that we should give you little.',
...
'And turning towards the Mountain he added: “Farewell Thorin Oakenshield!',
'And Fili and Kili!',
...
'“Farewell! O Gandalf!” said the king.',
...
'The Wild was still the Wild, and there were many other things in it in those days beside goblins; but he was well guided and well guarded—the wizard was with him, and Beorn for much of the way—and he was never in great danger again.',
...
'The goblins of the Misty Mountains were now few and terrified, and hidden in the deepest holes they could find; and the Wargs had vanished from the woods, so that men went abroad without fear.',
...
'and though he longed for home, Bilbo left with regret, for the flowers of the gardens of Beorn were in springtime no less marvellous than in high summer.',
...
'Wild, and to the ford beneath the steep bank, which you may remember.',
...
'At each point on the road Bilbo recalled the happenings and the words of a year ago—it seemed to him more like ten—',
'so that, of course, he quickly noted the place where the pony had fallen in the river, and they had turned aside for their nasty adventure with Tom and Bert and Bill.',
