...
'Yes, Doctor Jones, we’ve heard a great deal about you.',
'Have you?',
...
'Mmm.',
'Doctor Jones, now, you must understand that this is all strictly confidential, eh?',
'I understand.',
'Uh…',
...
'Frankly, we’re somewhat suspicious of Mister Ravenwood.',
...
'Yes.',
'Mister Katanga.',
'Mister Katanga, these are my friends.',
'They are my family.',
...
'Go away.',
'Yes, it hurts. Ow!',
'Well, God damn it, Indy, where doesn’t it hurt?',
'Here!',
'Here.',
'This isn’t… too bad.',
'Here…',
...
'Excuse me.',
'I can’t find Mister Jones, Captain.',
...
'And it will be, I assure you, Doctor Brody, Doctor Jones.',
...
'Mummies.',
'Doctor Jones found Nurhachi for me, and he’s going to deliver him now.',
...
'Antidote.',
'To what?',
'The poison you just drank, Doctor Jones.',
'The poison works fast, Doctor Jones.',
'Lao!\nLao.',
...
'Don’t be sad, Doctor Jones. You will soon be joining him.',
'Too much to drink, Doctor Jones?',
'Oh, nuts!',
'The antidote.',
'Where’s the diamond?',
'No!',
...
'Okay, Doctor Jones, Doctor Jones. Oh, wake up, please!',
...
'Doctor Jones, did they make the plane crash to get you here?',
...
'Hey! You cheat, Doctor Jones. You cheat!',
'What do you mean?',
'You take four card.',
'You pay now.',
...
'Sweet dreams, Doctor Jones.',
'Where are you going?',
'I’d sleep closer, if I were you.',
'For safety’s sake.',
'Doctor Jones, I’d be safer sleeping with a snake.',
'I said, cut it out!',
...
'Doctor Jones, the eminent archeologist?',
...
'And you, sir, are Doctor Jones, I presume.',
'I am, Captain.',
...
'Mister Lal, what do they call the Maharajah’s wife?',
...
'And what events are those, Doctor Jones?',
'Well, if memory serves me correctly, this area, this province, was the center of activity for the Thuggee.',
'Snake… Surprise.',
'What’s the surprise?',
'Doctor Jones, you know perfectly well the Thuggee cult has been dead for nearly a century.',
'Yes, of course.',
...
'Village stories, Doctor Jones.',
'They’re just fear and folklore.',
'You’re beginning to worry Captain Blumburtt.',
'I’m not worried, Mister Prime Minister, just interested.',
...
'Doctor Jones, in our country, it’s not usual for a guest to insult his host.',
'I’m sorry.',
...
'Doctor Jones, we are all vulnerable to vicious rumors.',
...
'And you’re just too proud to admit that you’re crazy about me, Doctor Jones.',
...
'Tell Mister Havelock that there are men looting in the caves.',
'Have him bring the sheriff.',
'It’s only a snake.',
'Did you hear what I said?',
'Right. Run back…',
'Mister Havelock… The sheriff…',
...
'Shush! Shush!',
'Doctor Jones, I am so glad you’re back. Your mail is on your desk. Here are your phone messages.',
...
'As you can now see, Doctor Jones… We’re about to complete a great quest that began almost two thousand years ago.',
...
'We received a cable from his colleague, Doctor Schneider, who has no idea of his whereabouts or what’s become of him.',
...
'Ah, Venice…',
'Yes.',
'How will we recognize this Doctor Schneider when we see him?',
...
'Elsa? Elsa?',
'That’s far enough. Put down the gun, Doctor Jones.',
...
'Doctor Schneider, there are pages torn out of this.',
...
'And this is how we say good-bye in Germany, Doctor Jones.',
...
'Booby traps?',
'Oh, yes.',
'But I found the clues that will safely take us through, in the Chronicles of Saint Anselm.',
'Well, what are they?',
'Can’t you remember?',
...
'Dad! Dad! Dad! Get out!',
'Diese Amerikane. Sie Kampfen wie Weiber.',
'Henry, the pen…',
'What?',
...
'Step back now, Doctor Schneider. Give Doctor Jones some room.',
...
'Za mnoy reebiata! Bistro! Bistro!',
'Russians.',
...
'Derzhite yego ruki za spinoy.',
'Where was he found?',
'In Mexico.',
'They were digging in the dirt, looking for this stuff.',
'You’re not from around here, are you?',
'Where is it you would imagine I am from, Doctor Jones?',
...
'Vse, podkhodite. Zavodi svoi mashiny, dvigaysya bystro!',
...
'No defiant last words, Doctor Jones?',
'I like Ike.',
'Put down gun.',
'You got it, pal.',
'Dostan’ yego!',
...
'Know him! Know him! You don’t know him! You don’t know him! You don’t know him! You don’t know…!',
'You did well.',
...
'…Howdy too, say howdy-do to you. Let’s give a rousing cheer. ‘Cause Howdy Doody’s here. It’s time to start the show. So kids, let’s go! 🎼',
'Minus ten seconds.',
...
'No. You mean that Air Force fiasco in ‘47.',
...
'Relax, boys. I can vouch for Doctor Jones.',
...
'Doctor Jones, let’s just say for now that you are of interest to the Bureau.',
'Of great interest.',
...
'Hey!',
'Hey, old man!',
'Professor, hello! Hey! Are you Doctor Jones?',
...
'Come quietly, Doctor Jones.',
'Make that KGB.',
'And bring letter with you.',
'Letter? What letter?',
'Letter Mister Williams just give you.',
...
'This is it. Sister.',
'Ne se donde esta el, pero te voy a mostrar la celda.',
'She says Ox isn’t here. She doesn’t know where he is.',
'Vinieron hombres armados, hombres malos, y se lo llevaron.',
'Some men came and took him away, men with guns.',
'El sabia que se me pegaba…',
'Estaba obsesionado con la pintura, pintaba toda las paredes al borde de la locura.',
'She says he was obsessed, deranged. Drew pictures all over the walls of his cell.',
'¡Y lo pique, lo pique, lo pique!',
...
'“Comrade”?',
'You think this is about flags? About uniforms? You think this is about lines on a map?',
...
'Just like in Berlin.',
'You want me to trot off, or should we sing a song? Heh.',
'How fortunate our failure to kill you, Doctor Jones.',
'You survive to be of service to us once again.',
'Well, you know me: always glad to help.',
'“Now I am become death, the destroyer of worlds.”',
'You recognize those words?',
'It was your own Doctor Oppenheimer, after he created the atomic bomb.',
...
'Heh, ha… Now I know why Oxley put the skull back where he found it.',
...
'And you were never this interesting. My name is In…',
...
'Surely you’re not afraid, Doctor Jones?',
...
'Whoever finds them will control the greatest natural force the world has ever known: power over the mind of man.',
...
'We will change you, Doctor Jones, all of you, from the inside.',
...
'“Mom”?!',
'Young man, I specifically told you not to come here yourself.',
'No, you didn’t.',
...
'Uh, no, I mean, I—I just never thought—',
...
'So, Doctor Jones, you will help us?',
...
'You got to tell us how to get there. We need speci…',
...
'Good, Ox. Good.',
'Ox?',
'It’s me, Ox. It’s Mutt, Ox.',
'Hey, look at me. Look at me. It’s me. It’s me.',
...
'Aah!',
'Void collapse.',
'I’ll go get somethin’ to pull you out.',
...
'Ah, it’s not the worst quality in the world.',
'Oh!',
...
'Pull…',
'Get rid of that thing, will ya… Son?',
'Afraid of snakes…',
'You are one crazy old man.',
'Why do you have to do everything the hard way, Jonesy? Huh?',
'Good work, Ox, thanks.',
'Help.',
...
'Indy!',
'Shut up!',
'Indy! You stupid son of a bitch! I’m C-I-A.',
'CIA?',
...
'Belief, Doctor Jones, is a gift you have yet to receive.',
'My sympathies.',
...
'Henry Jones, Junior, and Marion Ravenwood, insomuch in that you two have agreed to live together in holy matrimony, have promised your love for each other by these vows, the joining of your hands, and the giving of these rings, I now declare you to be husband and wife.',
