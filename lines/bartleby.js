...
'Ere introducing the scrivener, as he first appeared to me, it is fit I make some mention of myself, my employées, my business, my chambers, and general surroundings;',
...
'but I must be permitted to be rash here and declare, that I consider the sudden and violent abrogation of the office of Master in Chancery, by the new Constitution, as a—premature act;',
'inasmuch as I had counted upon a life-lease of the profits, whereas I only received those of a few short years.',
...
'In the morning, one might say, his face was of a fine florid hue, but after twelve o’clock, meridian—his dinner hour—it blazed like a grate full of Christmas coals;',
'and continued blazing—but, as it were, with a gradual wane—till 6 o’clock, p.m. or thereabouts, after which I saw no more of the proprietor of the face,',
'which gaining its meridian with the sun, seemed to set with it, to rise, culminate, and decline the following day, with the like regularity and undiminished glory.',
'There are many singular coincidences I have known in the course of my life, not the least among which was the fact, that exactly when Turkey displayed his fullest beams from his red and radiant countenance,',
'just then, too, at that critical moment, began the daily period when I considered his business capacities as seriously disturbed for the remainder of the twenty-four hours.',
...
'Nevertheless, as he was in many ways a most valuable person to me, and all the time before twelve o’clock, meridian, was the quickest, steadiest creature too, accomplishing a great deal of work in a style not easy to be matched—for these reasons,',
'I was willing to overlook his eccentricities, though indeed, occasionally, I remonstrated with him.',
...
'yet, at the same time made uncomfortable by his inflamed ways after twelve o’clock;',
...
'in short, he need not come to my chambers after twelve o’clock, but, dinner over, had best go home to his lodgings and rest himself till teatime.',
...
'Though concerning the self-indulgent habits of Turkey I had my own private surmises, yet touching Nippers I was well persuaded that whatever might be his faults in other respects, he was, at least, a temperate young man.',
...
'When I consider how, amid the stillness of my chambers, Nippers would sometimes impatiently rise from his seat,',
'and stooping over his table, spread his arms wide apart, seize the whole desk, and move it, and jerk it, with a grim, grinding motion on the floor,',
'as if the table were a perverse voluntary agent, intent on thwarting and vexing him;',
...
'Now my original business—that of a conveyancer and title hunter, and drawerup of recondite documents of all sorts—was considerably increased by receiving the master’s office.',
...
'In my haste and natural expectancy of instant compliance, I sat with my head bent over the original on my desk, and my right hand sideways, and somewhat nervously extended with the copy,',
'so that immediately upon emerging from his retreat, Bartleby might snatch it and proceed to business without the least delay.',
...
'Or, to repeat a previous sentence, Nippers’ ugly mood was on duty and Turkey’s off.) “Ginger Nut,” said I, willing to enlist the smallest suffrage in my behalf, “what do you think of it?”',
...
'With a little trouble we made out to examine the papers without Bartleby, though at every page or two, Turkey deferentially dropped his opinion that this proceeding was quite out of the common;',
'while Nippers, twitching in his chair with a dyspeptic nervousness, ground out between his set teeth occasional hissing maledictions against the stubborn oaf behind the screen.',
...
'Gingernuts are so called because they contain ginger as one of their peculiar constituents, and the final flavoring one.',
'Now what was ginger?',
'A hot, spicy thing.',
...
'But one afternoon the evil impulse in me mastered me, and the following little scene ensued: “Bartleby,” said I, “when those papers are all copied, I will compare them with you.”',
'“I would prefer not to.”',
'“How?',
'Surely you do not mean to persist in that mulish vagary?”',
'No answer.',
'I threw open the folding-doors near by, and turning upon Turkey and Nippers, exclaimed in an excited manner—“He says, a second time, he won’t examine his papers.',
...
'“Bartleby,” said I, “Ginger Nut is away; just step round to the Post Office, won’t you?',
...
'that he copied for me at the usual rate of four cents a folio (one hundred words);',
'but he was permanently exempt from examining the work done by him, that duty being transferred to Turkey and Nippers, one of compliment doubtless to their superior acuteness;',
...
'when to my consternation a key was turned from within;',
'and thrusting his lean visage at me, and holding the door ajar, the apparition of Bartleby appeared, in his shirt sleeves, and otherwise in a strangely tattered dishabille,',
'saying quietly that he was sorry, but he was deeply engaged just then, and—preferred not admitting me at present.',
...
'that incontinently I slunk away from my own door, and did as desired.',
...
'while his pale face clearly indicated that he never drank beer like Turkey, or tea and coffee even, like other men;',
'that he never went any where in particular that I could learn;',
...
'when I had feared to ask him to do the slightest incidental thing for me, even though I might know, from his long-continued motionlessness, that behind his screen he must be standing in one of those dead-wall reveries of his.',
...
'Finally, I resolved upon this;',
'—I would put certain calm questions to him the next morning, touching his history, etc.,',
'and if he declined to answer them openly and unreservedly (and I supposed he would prefer not),',
'then to give him a twenty dollar bill over and above whatever I might owe him, and tell him his services were no longer required;',
...
'Mortified as I was at his behavior, and resolved as I had been to dismiss him when I entered my offices,',
...
'It was plain that it involuntarily rolled form his tongue.',
...
'“Not gone!”',
'I murmured at last.',
'But again obeying that wondrous ascendancy which the inscrutable scrivener had over me, and from which ascendancy, for all my chafing, I could not completely escape,',
'I slowly went down stairs and out into the street, and while walking round the block, considered what I should next do in this unheard-of perplexity.',
...
'What was to be done? or, if nothing could be done, was there any thing further that I could assume in the matter?',
...
'Could you copy a small paper for me this morning? or help examine a few lines? or step round to the post-office?',
...
'It was the circumstance of being alone in a solitary office, up stairs, of a building entirely unhallowed by humanizing domestic associations—an uncarpeted office, doubtless, of a dusty, haggard sort of appearance;',
'—this it must have been, which greatly helped to enhance the irritable desperation of the hapless Colt.',
...
'Also, when a Reference was going on, and the room full of lawyers and witnesses and business was driving fast;',
'some deeply occupied legal gentleman present, seeing Bartleby wholly unemployed, would request him to run round to his (the legal gentleman’s) office and fetch some papers for him.',
...
'and scandalizing my professional reputation;',
'and casting a general gloom over the premises;',
'keeping soul and body together to the last upon his savings (for doubtless he spent but half a dime a day), and in the end perhaps outlive me, and claim possession of my office by right of his perpetual occupancy:',
'as all these dark anticipations crowded upon me more and more, and my friends continually intruded their relentless remarks upon the apparition in my room;',
'a great change was wrought in me.',
...
'But how?',
'You will not thrust him, the poor, pale, passive mortal,—you will not thrust such a helpless creature out of your door? you will not dishonor yourself by such cruelty?',
...
'Acting accordingly, next day I thus addressed him: “I find these chambers too far from the City Hall; the air is unwholesome.',
...
'“Good-bye, Bartleby; I am going—good-bye, and God some way bless you; and take that,” slipping something in his hand.',
...
'Fearful then of being exposed in the papers (as one person present obscurely threatened) I considered the matter, and at length said,',
'that if the lawyer would give me a confidential interview with the scrivener, in his (the lawyer’s) own room, I would that afternoon strive my best to rid them of the nuisance they complained of.',
...
'There is no trying of the eyesight in that.”',
...
'But ere parting with the reader, let me say, that if this little narrative has sufficiently interested him, to awaken curiosity as to who Bartleby was, and what manner of life he led prior to the present narrator’s making his acquaintance,',
'I can only reply, that in such curiosity I fully share, but am wholly unable to gratify it.',
...
'But inasmuch as this vague report has not been without certain strange suggestive interest to me, however sad, it may prove the same with some others; and so I will briefly mention it.',
