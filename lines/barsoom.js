...
'or he would sit for an hour at a time entertaining my old grandmother with stories of his strange, wild life in all parts of the world.',
...
'He was, when others were with him, the same genial, happy fellow we had known of old, but when he thought himself alone I have seen him sit for hours gazing off into space, his face set in a look of wistful longing and hopeless misery;',
...
'He remained with us for about a year and then went to New York, where he purchased a little place on the Hudson,',
'where I visited him once a year on the occasions of my trips to the New York market—my father and I owning and operating a string of general stores throughout Virginia at that time.',
...
'He told me at this time that if anything should happen to him he wished me to take charge of his estate,',
'and he gave me a key to a compartment in the safe which stood in his study, telling me I would find his will there and some personal instructions which he had me pledge myself to carry out with absolute fidelity.',
...
'I arrived at the little station, about a mile from his grounds, on the morning of March 4, 1886, and when I asked the livery man to drive me out to Captain Carter’s he replied that if I was a friend of the Captain’s he had some very bad news for me;',
'the Captain had been found dead shortly after daylight that very morning by the watchman attached to an adjoining property.',
...
'It lay, he said, stretched full length in the snow with the arms outstretched above the head toward the edge of the bluff,',
'and when he showed me the spot it flashed upon me that it was the identical one where I had seen him on those other nights, with his arms raised in supplication to the skies.',
...
'The morning of Powell’s departure was, like nearly all Arizona mornings, clear and beautiful;',
'I could see him and his little pack animals picking their way down the mountainside toward the valley, and all during the morning I would catch occasional glimpses of them as they topped a hog back or came out upon a level plateau.',
...
'Since we had entered the territory we had not seen a hostile Indian, and we had, therefore, become careless in the extreme,',
'and were wont to ridicule the stories we had heard of the great numbers of these vicious marauders that were supposed to haunt the trails, taking their toll in lives and torture of every white party which fell into their merciless clutches.',
...
'However, I am not prone to sensitiveness, and the following of a sense of duty, wherever it may lead, has always been a kind of fetich with me throughout my life;',
'which may account for the honors bestowed upon me by three republics and the decorations and friendships of an old and powerful emperor and several lesser kings, in whose service my sword has been red many a time.',
...
'because, in all of the hundreds of instances that my voluntary acts have placed me face to face with death, I cannot recall a single one where any alternative step to that I took occurred to me until many hours later.',
...
'In this instance I was, of course, positive that Powell was the center of attraction, but whether I thought or acted first I do not know,',
'but within an instant from the moment the scene broke upon my view I had whipped out my revolvers and was charging down upon the entire army of warriors, shooting rapidly, and whooping at the top of my lungs.',
...
'The fact that it is difficult to aim anything but imprecations accurately by moonlight, that they were upset by the sudden and unexpected manner of my advent,',
...
'My horse was traveling practically unguided as I knew that I had probably less knowledge of the exact location of the trail to the pass than he,',
'and thus it happened that he entered a defile which led to the summit of the range and not to the pass which I had hoped would carry me to the valley and to safety.',
...
'I soon became so drowsy that I could scarcely resist the strong desire to throw myself on the floor of the cave for a few moments’ rest, but I knew that this would never do, as it would mean certain death at the hands of my red friends, who might be upon me at any moment.',
...
'I remember that I hoped they would make short work of me as I did not particularly relish the thought of the innumerable things they might do to me if the spirit prompted them.',
...
'To be held paralyzed, with one’s back toward some horrible and unknown danger from the very sound of which the ferocious Apache warriors turn in wild stampede, as a flock of sheep would madly flee from a pack of wolves,',
'seems to me the last word in fearsome predicaments for a man who had ever been used to fighting for his life with all the energy of a powerful physique.',
...
'Late in the afternoon my horse, which had been standing with dragging rein before the cave, started slowly down the trail, evidently in search of food and water,',
'and I was left alone with my mysterious unknown companion and the dead body of my friend, which lay just within my range of vision upon the ledge where I had placed it in the early morning.',
...
'I reasoned with myself that I had lain helpless for many hours within the cave, yet nothing had molested me,',
'and my better judgment, when permitted the direction of clear and logical reasoning, convinced me that the noises I had heard must have resulted from purely natural and harmless causes;',
...
'the silvered mountains in the distance, the strange lights and shadows upon hog back and arroyo, and the grotesque details of the stiff, yet beautiful cacti form a picture at once enchanting and inspiring;',
'as though one were catching for the first time a glimpse of some dead and forgotten world, so different is it from the aspect of any other spot upon our earth.',
...
'Their eyes were set at the extreme sides of their heads a trifle above the center and protruded in such a manner that they could be directed either forward or back and also independently of each other,',
'thus permitting this queer animal to look in any direction, or in two directions at once, without the necessity of turning the head.',
...
'his two left arms were outstretched laterally to help preserve his balance, the thing he rode having neither bridle or reins of any description for guidance.',
'And his mount!',
...
'The result is that they are infinitely less agile and less powerful, in proportion to their weight, than an Earth man, and I doubt that were one of them suddenly to be transported to Earth he could lift his own weight from the ground;',
'in fact, I am convinced that he could not do so.',
...
'The respite my unexpected agility had given me permitted me to formulate plans for the immediate future and to note more closely the appearance of the warriors,',
'for I could not disassociate these people in my mind from those other warriors who, only the day before, had been pursuing me.',
...
'They started toward us on a wild run, but were checked by a signal from him.',
...
'I saw no signs of extreme age among them, nor is there any appreciable difference in their appearance from the age of maturity, about forty, until, at about the age of one thousand years,',
'they go voluntarily upon their last strange pilgrimage down the river Iss, which leads no living Martian knows whither and from whose bosom no Martian has ever returned, or would be allowed to live did he return after once embarking upon its cold, dark waters.',
...
'Owing to the waning resources of the planet it evidently became necessary to counteract the increasing longevity which their remarkable skill in therapeutics and surgery produced,',
...
'What struck me as most remarkable about this assemblage and the hall in which they were congregated was the fact that the creatures were entirely out of proportion to the desks, chairs, and other furnishings;',
'these being of a size adapted to human beings such as I, whereas the great bulks of the Martians could scarcely have squeezed into the chairs, nor was there room beneath the desks for their long legs.',
'Evidently, then, there were other denizens on Mars than the wild and grotesque creatures into whose hands I had fallen,',
'but the evidences of extreme antiquity which showed all around me indicated that these buildings might have belonged to some long-extinct and forgotten race in the dim antiquity of Mars.',
'Our party had halted at the entrance to the building, and at a sign from the leader I had been lowered to the ground.',
'Again locking his arm in mine, we had proceeded into the audience chamber.',
...
'At the time, this ceremony and the words they uttered meant nothing to me, but later I came to know that this was the customary greeting between green Martians.',
...
'As he banged me down upon my feet his face was bent close to mine and I did the only thing a gentleman might do under the circumstances of brutality, boorishness, and lack of consideration for a stranger’s rights;',
...
'My exhibition had been witnessed by several hundred lesser Martians, and they immediately broke into demands for a repetition, which the chieftain then ordered me to make;',
'but I was both hungry and thirsty, and determined on the spot that my only method of salvation was to demand the consideration from these creatures which they evidently would not voluntarily accord.',
...
'but upon all there seemed to rest that indefinable touch of the finger of antiquity which convinced me that the architects and builders of these wondrous creations had nothing in common with the crude half-brutes which now occupied them.',
...
'I could not but wonder what this ferocious-looking monstrosity might do when left alone in such close proximity to such a relatively tender morsel of meat;',
'but my fears were groundless, as the beast, after surveying me intently for a moment, crossed the room to the only exit which led to the street, and lay down full length across the threshold.',
...
'It came, as I later discovered, not from an animal, as there is only one mammal on Mars and that one very rare indeed,',
'but from a large plant which grows practically without water, but seems to distill its plentiful supply of milk from the products of the soil, the moisture of the air, and the rays of the sun.',
...
'on the other hand, if both of the moons are in the heavens at night the surface of the ground is brightly illuminated.',
...
'And it is well that nature has so graciously and abundantly lighted the Martian night, for the green men of Mars, being a nomadic race without high intellectual development, have but crude means for artificial lighting;',
'depending principally upon torches, a kind of candle, and a peculiar oil lamp which generates a gas and burns without a wick.',
'This last device produces an intensely brilliant far-reaching white light, but as the natural oil which it requires can only be obtained by mining in one of several widely separated and remote localities it is seldom used by these creatures whose only thought is for today,',
'and whose hatred for manual labor has kept them in a semi-barbaric state for countless ages.',
...
'He then fell in behind me and followed about ten paces in my rear as I made my way along the deserted street.',
...
'My beast had an advantage in his first hold, having sunk his mighty fangs far into the breast of his adversary;',
'but the great arms and paws of the ape, backed by muscles far transcending those of the Martian men I had seen, had locked the throat of my guardian and slowly were choking out his life,',
'and bending back his head and neck upon his body, where I momentarily expected the former to fall limp at the end of a broken neck.',
...
'Suddenly I came to myself and, with that strange instinct which seems ever to prompt me to my duty, I seized the cudgel, which had fallen to the floor at the commencement of the battle,',
'and swinging it with all the power of my earthly arms I crashed it full upon the head of the ape, crushing his skull as though it had been an eggshell.',
...
'I am ever willing to stand and fight when the odds are not too overwhelmingly against me, but in this instance I perceived neither glory nor profit in pitting my relatively puny strength against the iron muscles and brutal ferocity of this enraged denizen of an unknown world;',
...
'Evidently devoid of all the finer sentiments of friendship, love, or affection, these people fairly worship physical prowess and bravery,',
'and nothing is too good for the object of their adoration as long as he maintains his position by repeated examples of his skill, strength, and courage.',
...
'After a breakfast, which was an exact replica of the meal of the preceding day and an index of practically every meal which followed while I was with the green men of Mars, Sola escorted me to the plaza,',
'where I found the entire community engaged in watching or helping at the harnessing of huge mastodonian animals to great three-wheeled chariots.',
...
'Our way led out across the little valley before the city, through the hills, and down into the dead sea bottom which I had traversed on my journey from the incubator to the plaza.',
...
'On reaching it the chariots were parked with military precision on the four sides of the enclosure, and half a score of warriors, headed by the enormous chieftain, and including Tars Tarkas and several other lesser chiefs, dismounted and advanced toward it.',
...
'being permitted to run the full length of the aisle, where they were captured one at a time by the women and older children;',
'the last in the line capturing the first little one to reach the end of the gauntlet, her opposite in the line capturing the second, and so on until all the little fellows had left the enclosure and been appropriated by some youth or female.',
...
'I do not mean that the adult Martians are unnecessarily or intentionally cruel to the young,',
'but theirs is a hard and pitiless struggle for existence upon a dying planet, the natural resources of which have dwindled to a point where the support of each additional life means an added tax upon the community into which it is thrown.',
...
'Why they did not arrange to build their vaults and incubators nearer home has always been a mystery to me, and, like many other Martian mysteries, unsolved and unsolvable by earthly reasoning and customs.',
...
'The Martian language, as I have said, is extremely simple, and in a week I could make all my wants known and understand nearly everything that was said to me.',
...
'Sola and I had entered a building upon the front of the city, in fact, the same one in which I had had my encounter with the apes,',
'and, wishing to see what had caused the sudden retreat, I mounted to an upper floor and peered from the window out over the valley and the hills beyond;',
'and there I saw the cause of their sudden scurrying to cover.',
...
'Whether they had discovered us or simply were looking at the deserted city I could not say, but in any event they received a rude reception,',
'for suddenly and without warning the green Martian warriors fired a terrific volley from the windows of the buildings facing the little valley across which the great ships were so peacefully advancing.',
'Instantly the scene changed as by magic;',
'the foremost vessel swung broadside toward us,',
'and bringing her guns into play returned our fire, at the same time moving parallel to our front for a short distance and then turning back with the evident intention of completing a great circle which would bring her up to position once more opposite our firing line;',
...
'It had never been given me to see such deadly accuracy of aim,',
'and it seemed as though a little figure on one of the craft dropped at the explosion of each bullet, while the banners and upper works dissolved in spurts of flame as the irresistible projectiles of our warriors mowed through them.',
...
'For example, a proportion of them, always the best marksmen, direct their fire entirely upon the wireless finding and sighting apparatus of the big guns of an attacking naval force;',
'another detail attends to the smaller guns in the same way;',
'others pick off the gunners;',
'still others the officers;',
'while certain other quotas concentrate their attention upon the other members of the crew, upon the upper works, and upon the steering gear and propellers.',
...
'As the craft neared the building, and just before she struck, the Martian warriors swarmed upon her from the windows,',
'and with their great spears eased the shock of the collision, and in a few moments they had thrown out grappling hooks and the big boat was being hauled to ground by their fellows below.',
...
'This operation required several hours, during which time a number of the chariots were requisitioned to transport the loot, which consisted in arms, ammunition, silks, furs, jewels, strangely carved stone vessels,',
...
'The sight was awe-inspiring in the extreme as one contemplated this mighty floating funeral pyre, drifting unguided and unmanned through the lonely wastes of the Martian heavens;',
'a derelict of death and destruction, typifying the life story of these strange and ferocious creatures into whose unfriendly hands fate had carried it.',
...
'I could not fathom the seeming hallucination, nor could I free myself from it;',
'but somewhere in the innermost recesses of my soul I felt a strange yearning toward these unknown foemen, and a mighty hope surged through me that the fleet would return and demand a reckoning from the green warriors who had so ruthlessly and wantonly attacked it.',
'Close at my heel, in his now accustomed place, followed Woola, the hound, and as I emerged upon the street Sola rushed up to me as though I had been the object of some search on her part.',
...
'for just as we neared the throng of Martians I caught a glimpse of the prisoner from the battle craft who was being roughly dragged into a nearby building by a couple of green Martian females.',
...
'With this added incentive I nearly drove Sola distracted by my importunities to hasten on my education',
'and within a few more days I had mastered the Martian tongue sufficiently well to enable me to carry on a passable conversation and to fully understand practically all that I heard.',
...
'“What will be the manner of her going out?” inquired Sola.',
...
'She had warned me, however, against venturing forth unarmed, as this city, like all other deserted metropolises of an ancient Martian civilization, was peopled by the great white apes of my second day’s adventure.',
'In advising me that I must not leave the boundaries of the city Sola had explained that Woola would prevent this anyway should I attempt it,',
'and she warned me most urgently not to arouse his fierce nature by ignoring his warnings should I venture too close to the forbidden territory.',
...
'It also occurred to me that this would prove an excellent opportunity to test the qualities of Woola.',
'I was convinced that the brute loved me;',
'I had seen more evidences of affection in him than in any other Martian animal, man or beast, and I was sure that gratitude for the acts that had twice saved his life would more than outweigh his loyalty to the duty imposed upon him by cruel and loveless masters.',
...
'Denied the friendship and companionship of my kind, I had developed considerable affection for Woola and Sola,',
'for the normal earthly man must have some outlet for his natural affections, and so I decided upon an appeal to a like instinct in this great brute, sure that I would not be disappointed.',
'I had never petted nor fondled him,',
'but now I sat upon the ground and putting my arms around his heavy neck I stroked and coaxed him, talking in my newly acquired Martian tongue as I would have to my hound at home, as I would have talked to any other friend among the lower animals.',
...
'I could not resist the ludicrousness of the spectacle, and holding my sides I rocked back and forth in the first laughter which had passed my lips in many days;',
'the first, in fact, since the morning Powell had left camp when his horse, long unused, had precipitately and unexpectedly bucked him off headforemost into a pot of frijoles.',
...
'Numerous brilliantly colored and strangely formed wild flowers dotted the ravines and from the summit of the first hill I saw still other hills stretching off toward the north, and rising, one range above another, until lost in mountains of quite respectable dimensions;',
'though I afterward found that only a few peaks on all Mars exceed four thousand feet in height;',
...
'it was good to know that someone else on Mars beside myself had human instincts of a civilized order, even though the manifestation of them was so painful and mortifying.',
...
'I had not long to wait for presently Lorquas Ptomel and his retinue of chieftains approached the building and, signing the guards to follow with the prisoner entered the audience chamber.',
'Realizing that I was a somewhat favored character,',
'and also convinced that the warriors did not know of my proficiency in their language, as I had plead with Sola to keep this a secret on the grounds that I did not wish to be forced to talk with the men until I had perfectly mastered the Martian tongue,',
'I chanced an attempt to enter the audience chamber and listen to the proceedings.',
...
'When it was necessary to move from one spot to another she either jerked her roughly, or pushed her headlong before her.',
...
'A people without written language, without art, without homes, without love; the victims of eons of the horrible community idea.',
...
'What words of moment were to have fallen from his lips were never spoken, as just then a young warrior, evidently sensing the trend of thought among the older men, leaped down from the steps of the rostrum,',
'and striking the frail captive a powerful blow across the face, which felled her to the floor, placed his foot upon her prostrate form and turning toward the assembled council broke into peals of horrid, mirthless laughter.',
...
'Springing upward, I struck him full in the face as he turned at my warning cry and then as he drew his short-sword I drew mine and sprang up again upon his breast,',
'hooking one leg over the butt of his pistol and grasping one of his huge tusks with my left hand while I delivered blow after blow upon his enormous chest.',
'He could not use his short-sword to advantage because I was too close to him,',
'nor could he draw his pistol, which he attempted to do in direct opposition to Martian custom which says that you may not fight a fellow warrior in private combat with any other than the weapon with which you are attacked.',
...
'We were interrupted at this juncture by the approach of one of the warriors, bearing arms, accoutrements and ornaments, and in a flash one of her questions was answered and a puzzle cleared up for me.',
'I saw that the body of my dead antagonist had been stripped,',
'and I read in the menacing yet respectful attitude of the warrior who had brought me these trophies of the kill the same demeanor as that evinced by the other who had brought me my original equipment,',
'and now for the first time I realized that my blow, on the occasion of my first battle in the audience chamber had resulted in the death of my adversary.',
'The reason for the whole attitude displayed toward me was now apparent;',
'I had won my spurs, so to speak, and in the crude justice, which always marks Martian dealings, and which, among other things, has caused me to call her the planet of paradoxes, I was accorded the honors due a conqueror;',
...
'“Should you, in recognition of your remarkable valor, ferocity, and prowess, be considered by Tal Hajus as worthy of his service you may be taken into the community and become a full-fledged Tharkian.',
...
'You will be treated by us as a Tharkian chieftain, but you must not forget that every chief who ranks you is responsible for your safe delivery to our mighty and most ferocious ruler.',
'I am done.”',
'“I hear you, Tars Tarkas,” I answered.',
...
'Ordinarily I am not given to long speeches, nor ever before had I descended to bombast, but I had guessed at the keynote which would strike an answering chord in the breasts of the green Martians, nor was I wrong,',
'for my harangue evidently deeply impressed them, and their attitude toward me thereafter was still further respectful.',
...
'Only in the valley Dor, where the river Iss empties into the lost sea of Korus, is there supposed to be a different language spoken,',
'and, except in the legends of our ancestors, there is no record of a Barsoomian returning up the river Iss, from the shores of Korus in the valley of Dor.',
...
'she drew away from me with a sigh, and with her earnest, beautiful face turned up to mine, she whispered: “I believe you, John Carter;',
'I do not know what a ‘gentleman’ is, nor have I ever heard before of Virginia;',
'but on Barsoom no man lies;',
'if he does not wish to speak the truth he is silent.',
...
'Finally she smiled, and, rising, said: “I shall have to believe even though I cannot understand.',
...
'“Because, John Carter,” she replied, “nearly every planet and star having atmospheric conditions at all approaching those of Barsoom, shows forms of animal life almost identical with you and me;',
'and, further, Earth men, almost without exception, cover their bodies with strange, unsightly pieces of cloth, and their heads with hideous contraptions the purpose of which we have been unable to conceive;',
'while you, when found by the Tharkian warriors, were entirely undisfigured and unadorned.',
...
'These three great divisions of the higher Martians had been forced into a mighty alliance as the drying up of the Martian seas had compelled them to seek the comparatively few and always diminishing fertile areas,',
'and to defend themselves, under new conditions of life, against the wild hordes of green men.',
...
'During the ages of hardships and incessant warring between their own various races, as well as with the green men, and before they had fitted themselves to the changed conditions, much of the high civilization and many of the arts of the fair-haired Martians had become lost;',
'but the red race of today has reached a point where it feels that it has made up in new discoveries and in a more practical civilization for all that lies irretrievably buried with the ancient Barsoomians, beneath the countless intervening ages.',
...
'and lesser ones, in diminishing numbers, were to be found converging toward the center of the oceans, as the people had found it necessary to follow the receding waters until necessity had forced upon them their ultimate salvation, the so-called Martian canals.',
...
'it is I who shall have to face Tars Tarkas, and either demonstrate my right to command, or the metal from my dead carcass will go to a better man, for such is the custom of the Tharks.',
'“I have no quarrel with Tars Tarkas; together we rule supreme the greatest of the lesser communities among the green men; we do not wish to fight between ourselves; and so if you were dead, John Carter, I should be glad.',
...
'His demeanor toward me was unchanged, and he greeted me as though we had not just parted a few moments before.',
...
'Well, as you have said, your ways are not our ways, but you can fight well enough to do about as you please, and so, if you wish to give your woman to a captive, it is your own affair;',
'but as a chieftain you should have those to serve you, and in accordance with our customs you may select any or all the females from the retinues of the chieftains whose metal you now wear.”',
'I thanked him, but assured him that I could get along very nicely without assistance except in the matter of preparing food,',
'and so he promised to send women to me for this purpose and also for the care of my arms and the manufacture of my ammunition, which he said would be necessary.',
'I suggested that they might also bring some of the sleeping silks and furs which belonged to me as spoils of combat, for the nights were cold and I had none of my own.',
...
'The beauties of the other buildings were repeated in this, and, as usual, I was soon lost in a tour of investigation and discovery.',
'I finally chose a front room on the third floor, because this brought me nearer to Dejah Thoris, whose apartment was on the second floor of the adjoining building,',
'and it flashed upon me that I could rig up some means of communication whereby she might signal me in case she needed either my services or my protection.',
...
'The windows of the back rooms overlooked an enormous court, which formed the center of the square made by the buildings which faced the four contiguous streets,',
'and which was now given over to the quartering of the various animals belonging to the warriors occupying the adjoining buildings.',
'While the court was entirely overgrown with the yellow, moss-like vegetation which blankets practically the entire surface of Mars, yet numerous fountains, statuary, benches,',
'and pergola-like contraptions bore witness to the beauty which the court must have presented in bygone times, when graced by the fair-haired, laughing people whom stern and unalterable cosmic laws had driven not only from their homes,',
...
'The women and children of a man’s retinue may be likened to a military unit for which he is responsible in various ways, as in matters of instruction, discipline, sustenance,',
'and the exigencies of their continual roamings and their unending strife with other communities and with the red Martians.',
...
'In theory it may sound well, as is often the case with theories, but the results of ages of this unnatural practice, coupled with the community interest in the offspring being held paramount to that of the mother, is shown in the cold, cruel creatures,',
...
'Following the battle with the air ships, the community remained within the city for several days, abandoning the homeward march until they could feel reasonably assured that the ships would not return;',
'for to be caught on the open plains with a cavalcade of chariots and children was far from the desire of even so warlike a people as the green Martians.',
...
'Two of these animals had fallen to me from the warriors whose metal I wore, and in a short time I could handle them quite as well as the native warriors.',
'The method was not at all complicated.',
'If the thoats did not respond with sufficient celerity to the telepathic instructions of their riders they were dealt a terrific blow between the ears with the butt of a pistol,',
'and if they showed fight this treatment was continued until the brutes either were subdued, or had unseated their riders.',
...
'“You see, Tars Tarkas, the softer sentiments have their value, even to a warrior.',
...
'During the days just preceding our departure I had seen but little of Dejah Thoris, as I had been kept very busy by Tars Tarkas with my lessons in the art of Martian warfare, as well as in the training of my thoats.',
'The few times I had visited her quarters she had been absent, walking upon the streets with Sola, or investigating the buildings in the near vicinity of the plaza.',
...
'I liked and trusted Sola, but for some reason I desired to be alone with Dejah Thoris, who represented to me all that I had left behind upon Earth in agreeable and congenial companionship.',
'There seemed bonds of mutual interest between us as powerful as though we had been born under the same roof rather than upon different planets, hurtling through space some forty-eight million miles apart.',
...
'[I have used the word radium in describing this powder because in the light of recent discoveries on Earth I believe it to be a mixture of which radium is the base.',
...
'“I presume it is the better part of wisdom that we bow to our fate with as good grace as possible, Dejah Thoris;',
...
'I do not know why it is that I should always be happy and contented when you, John Carter, a stranger, are with me;',
'yet at such times it seems that I am safe and that, with you, I shall soon return to my father’s court and feel his strong arms about me and my mother’s tears and kisses on my cheek.”',
...
'“But I have fought—” I started, and then I wished my tongue had been cut from my mouth;',
'for she turned even as I caught myself and ceased, and drawing my silks from her shoulder she held them out to me, and without a word, and with head held high, she moved with the carriage of the queen she was toward the plaza and the doorway of her quarters.',
...
'So this was love!',
'I had escaped it for all the years I had roamed the five continents and their encircling seas;',
'in spite of beautiful women and urging opportunity;',
'in spite of a half-desire for love and a constant search for my ideal, it had remained for me to fall furiously and hopelessly in love with a creature from another world, of a species similar possibly, yet not identical with mine.',
'A woman who was hatched from an egg, and whose span of life might cover a thousand years;',
'whose people had strange customs and ideas;',
...
'I believed that from the bottom of my heart, from the depth of my soul on that night in Korad as I sat cross-legged upon my silks while the nearer moon of Barsoom raced through the western sky toward the horizon,',
'and lighted up the gold and marble, and jeweled mosaics of my world-old chamber,',
'and I believe it today as I sit at my desk in the little study overlooking the Hudson.',
...
'With the foolish inconsistency of love I held my peace when I might have pled ignorance of the nature of my offense, or at least the gravity of it, and so have effected, at worst, a half conciliation.',
...
'A few moments later I saw her deep in conversation with a warrior named Zad;',
'a big, hulking, powerful brute, but one who had never made a kill among his own chieftains, and so was still an o mad, or man with one name;',
'he could win a second name only with the metal of some chieftain.',
'It was this custom which entitled me to the names of either of the chieftains I had killed;',
'in fact, some of the warriors addressed me as Dotar Sojat, a combination of the surnames of the two warrior chieftains whose metal I had taken, or, in other words, whom I had slain in fair fight.',
...
'There were two little kiddies in the Carter family whom I had loved and who had thought there was no one on Earth like Uncle Jack;',
...
'By nature a wanderer, I had never known the true meaning of the word home, but the great hall of the Carters had always stood for all that the word did mean to me, and now my heart turned toward it from the cold and unfriendly peoples I had been thrown amongst.',
'For did not even Dejah Thoris despise me!',
'I was a low creature, so low in fact that I was not even fit to polish the teeth of her grandmother’s cat;',
'and then my saving sense of humor came to my rescue, and laughing I turned into my silks and furs and slept upon the moon-haunted ground the sleep of a tired and healthy fighting man.',
...
'About noon we espied far to our right what was evidently an incubator, and Lorquas Ptomel directed Tars Tarkas to investigate it.',
...
'As a matter of fact, the new-laid egg is but little larger than an ordinary goose egg,',
'and as it does not commence to grow until subjected to the light of the sun the chieftains have little difficulty in transporting several hundreds of them at one time from the storage vaults to the incubators.',
...
'I did not need a manual of green Martian etiquette to know what reply to make, for, in fact, I was so wild with anger that I could scarcely refrain from drawing my pistol and shooting him down for the brute he was;',
'but he stood waiting with drawn long-sword, and my only choice was to draw my own and meet him in fair fight with his choice of weapons or a lesser one.',
...
'Finally Zad, realizing that he was tiring more than I, evidently decided to close in and end the battle in a final blaze of glory for himself;',
'just as he rushed me a blinding flash of light struck full in my eyes, so that I could not see his approach and could only leap blindly to one side in an effort to escape the mighty blade that it seemed I could already feel in my vitals.',
...
'Another thing I saw, too, which almost lost my life for me then and there, for it took my mind for the fraction of an instant entirely from my antagonist;',
'for, as Dejah Thoris struck the tiny mirror from her hand, Sarkoja, her face livid with hatred and baffled rage, whipped out her dagger and aimed a terrific blow at Dejah Thoris;',
'and then Sola, our dear and faithful Sola, sprang between them;',
'the last I saw was the great knife descending upon her shielding breast.',
...
'We rushed each other furiously time after time, ‘til suddenly, feeling the sharp point of his sword at my breast in a thrust I could neither parry nor escape,',
'I threw myself upon him with outstretched sword and with all the weight of my body, determined that I would not die alone if I could prevent it.',
...
'As soon as they were through with me I hastened to the chariot of Dejah Thoris, where I found my poor Sola with her chest swathed in bandages, but apparently little the worse for her encounter with Sarkoja,',
'whose dagger it seemed had struck the edge of one of Sola’s metal breast ornaments and, thus deflected, had inflicted but a slight flesh wound.',
...
'We made a most imposing and awe-inspiring spectacle as we strung out across the yellow landscape;',
'the two hundred and fifty ornate and brightly colored chariots, preceded by an advance guard of some two hundred mounted warriors and chieftains riding five abreast and one hundred yards apart,',
'and followed by a like number in the same formation, with a score or more of flankers on either side;',
'the fifty extra mastodons, or heavy draught animals, known as zitidars, and the five or six hundred extra thoats of the warriors running loose within the hollow square formed by the surrounding warriors.',
'The gleaming metal and jewels of the gorgeous ornaments of the men and women, duplicated in the trappings of the zitidars and thoats,',
'and interspersed with the flashing colors of magnificent silks and furs and feathers, lent a barbaric splendor to the caravan which would have turned an East Indian potentate green with envy.',
'The enormous broad tires of the chariots and the padded feet of the animals brought forth no sound from the moss-covered sea bottom;',
'and so we moved in utter silence, like some huge phantasmagoria, except when the stillness was broken by the guttural growling of a goaded zitidar, or the squealing of fighting thoats.',
...
'It was the first march of a large body of men and animals I had ever witnessed which raised no dust and left no spoor;',
'for there is no dust upon Mars except in the cultivated districts during the winter months, and even then the absence of high winds renders it almost unnoticeable.',
...
'Our animals had been two days without drink, nor had they had water for nearly two months, not since shortly after leaving Thark;',
'but, as Tars Tarkas explained to me, they require but little and can live almost indefinitely upon the moss which covers Barsoom, and which, he told me, holds in its tiny stems sufficient moisture to meet the limited demands of the animals.',
...
'From what I have learned of you and the ways of your people I am sure that the tale will not seem strange to you, but among green Martians it has no parallel within the memory of the oldest living Thark, nor do our legends hold many similar tales.',
...
'She was also less cold and cruel than most green Martian women,',
'and caring little for their society, she often roamed the deserted avenues of Thark alone, or went and sat among the wild flowers that deck the nearby hills, thinking thoughts and wishing wishes which I believe I alone among Tharkian women today may understand,',
...
'She trusted him and told him of the awful repugnance she felt for the cruelties of their kind, for the hideous, loveless lives they must ever lead, and then she waited for the storm of denunciation to break from his cold, hard lips;',
...
'His love for my mother had never diminished, and his own ambition in life was to reach a point where he might wrest the metal from Tal Hajus himself,',
'and thus, as ruler of the Tharks, be free to claim her as his own, as well as, by the might of his power, protect the child which otherwise would be quickly dispatched should the truth become known.',
...
'But one day the chance was lost forever, in so far as it could come in time to save his loved ones,',
'for he was ordered away upon a long expedition to the ice-clad south, to make war upon the natives there and despoil them of their furs,',
'for such is the manner of the green Barsoomian;',
'he does not labor for what he can wrest in battle from others.',
...
'and one night she told me the story I have told to you up to this point,',
'impressing upon me the necessity for absolute secrecy and the great caution I must exercise after she had placed me with the other young Tharks to permit no one to guess that I was further advanced in education than they,',
'nor by any sign to divulge in the presence of others my affection for her, or my knowledge of my parentage;',
'and then drawing me close to her she whispered in my ear the name of my father.',
...
'The torrent of hatred and abuse she poured out upon her turned my young heart cold in terror.',
...
'This was apparent from her repeated demands upon my mother to disclose the name of her partner in sin, but no amount of abuse or threats could wring this from her, and to save me from needless torture she lied,',
'for she told Sarkoja that she alone knew nor would she ever tell her child.',
'“With final imprecations, Sarkoja hastened away to Tal Hajus to report her discovery,',
'and while she was gone my mother, wrapping me in the silks and furs of her night coverings, so that I was scarcely noticeable,',
'descended to the streets and ran wildly away toward the outskirts of the city, in the direction which led to the far south,',
'out toward the man whose protection she might not claim, but on whose face she wished to look once more before she died.',
...
'She was imprisoned by Tal Hajus, and every effort, including the most horrible and shameful torture, was brought to bear upon her to wring from her lips the name of my father;',
'but she remained steadfast and loyal, dying at last amidst the laughter of Tal Hajus and his chieftains during some awful torture she was undergoing.',
...
'From that moment on he was the cruelest of the cruel, and I am awaiting the day when he shall win the goal of his ambition, and feel the carcass of Tal Hajus beneath his foot,',
...
'Presently she spoke.',
'“John Carter, if ever a real man walked the cold, dead bosom of Barsoom you are one.',
'I know that I can trust you, and because the knowledge may someday help you or him or Dejah Thoris or myself, I am going to tell you the name of my father, nor place any restrictions or conditions upon your tongue.',
...
'When we approached these points a warrior would be sent far ahead with a powerful field glass,',
'and if no great body of red Martian troops was in sight we would advance as close as possible without chance of being seen and then camp until dark, when we would slowly approach the cultivated tract,',
'and, locating one of the numerous, broad highways which cross these areas at regular intervals, creep silently and stealthily across to the arid lands upon the other side.',
'It required five hours to make one of these crossings without a single halt, and the other consumed the entire night, so that we were just leaving the confines of the high-walled fields when the sun broke out upon us.',
'Crossing in the darkness, as we did, I was unable to see but little, except as the nearer moon, in her wild and ceaseless hurtling through the Barsoomian heavens, lit up little patches of the landscape from time to time,',
'disclosing walled fields and low, rambling buildings, presenting much the appearance of earthly farms.',
...
'Not once did I have speech with Dejah Thoris, as she sent no word to me that I would be welcome at her chariot, and my foolish pride kept me from making any advances.',
...
'Each community has its own jed and lesser chieftains, but all are under the rule of Tal Hajus, Jeddak of Thark.',
...
'Those who chanced to be in sight spoke the names of warriors or women with whom they came in direct contact, in the formal greeting of their kind, but when it was discovered that they brought two captives a greater interest was aroused,',
...
'My quarters would have been suitable for housing the greatest of earthly emperors, but to these queer creatures nothing about a building appealed to them but its size and the enormity of its chambers;',
'the larger the building, the more desirable;',
'and so Tal Hajus occupied what must have been an enormous public building, the largest in the city, but entirely unfitted for residence purposes;',
'the next largest was reserved for Lorquas Ptomel, the next for the jed of a lesser rank, and so on to the bottom of the list of five jeds.',
...
'The selection of building had to be made in accordance with these divisions, except in so far as the jeds were concerned, they all occupying edifices which fronted upon the plaza.',
'When I had finally put my house in order, or rather seen that it had been done, it was nearing sunset,',
'and I hastened out with the intention of locating Sola and her charges, as I had determined upon having speech with Dejah Thoris and trying to impress on her the necessity of our at least patching up a truce until I could find some way of aiding her to escape.',
...
'“I am saying what I had promised myself that I would not say to you, at least until you were no longer a captive among the green men;',
'what from your attitude toward me for the past twenty days I had thought never to say to you;',
'I am saying, Dejah Thoris, that I am yours, body and soul, to serve you, to fight for you, and to die for you.',
...
'“I will respect your wishes, John Carter, because I understand the motives which prompt them, and I accept your service no more willingly than I bow to your authority; your word shall be my law.',
...
'Will you not accompany us in one supreme effort to escape?',
'I am sure that Dejah Thoris can offer you a home and protection among her people, and your fate can be no worse among them than it must ever be here.”',
'“Yes,” cried Dejah Thoris, “come with us, Sola, you will be better off among the red men of Helium than you are here, and I can promise you not only a home with us, but the love and affection your nature craves and which must always be denied you by the customs of your own race.',
'Come with us, Sola; we might go without you, but your fate would be terrible if they thought you had connived to aid us.',
'I know that even that fear would not tempt you to interfere in our escape, but we want you with us, we want you to come to a land of sunshine and happiness, amongst a people who know the meaning of love, of sympathy, and of gratitude.',
...
'There were other cities closer, but she said she feared to enter many of them, as they were not all friendly toward Helium.',
...
'Sola was to ride one and Dejah Thoris and I the other; each of us carrying sufficient food and drink to last us for two days, since the animals could not be urged too rapidly for so long a distance.',
'I directed Sola to proceed with Dejah Thoris along one of the less frequented avenues to the southern boundary of the city, where I would overtake them with the thoats as quickly as possible;',
'then, leaving them to gather what food, silks, and furs we were to need, I slipped quietly to the rear of the first floor, and entered the courtyard, where our animals were moving restlessly about, as was their habit, before settling down for the night.',
'In the shadows of the buildings and out beneath the radiance of the Martian moons moved the great herd of thoats and zitidars,',
'the latter grunting their low gutturals and the former occasionally emitting the sharp squeal which denotes the almost habitual state of rage in which these creatures passed their existence.',
...
'I was sure that Sola and Dejah Thoris would find no difficulty in reaching our rendezvous undetected, but with my great thoats I was not so sure for myself, as it was quite unusual for warriors to leave the city after dark;',
'in fact there was no place for them to go within any but a long ride.',
...
'Presuming that one of the other women of the same household may have come in to speak to Sola,',
'and so delayed their departure, I did not feel any undue apprehension until nearly an hour had passed without a sign of them,',
'and by the time another half hour had crawled away I was becoming filled with grave anxiety.',
'Then there broke upon the stillness of the night the sound of an approaching party, which, from the noise, I knew could be no fugitives creeping stealthily toward liberty.',
'Soon the party was near me, and from the black shadows of my entranceway I perceived a score of mounted warriors, who, in passing, dropped a dozen words that fetched my heart clean into the top of my head.',
'“He would likely have arranged to meet them just without the city, and so—” I heard no more, they had passed on; but it was enough.',
'Our plan had been discovered, and the chances for escape from now on to the fearful end would be small indeed.',
'My one hope now was to return undetected to the quarters of Dejah Thoris and learn what fate had overtaken her,',
'but how to do it with these great monstrous thoats upon my hands, now that the city probably was aroused by the knowledge of my escape was a problem of no mean proportions.',
...
'and thus we finally made the inner court where I found, as I had expected, the usual carpet of moss-like vegetation which would provide their food and drink until I could return them to their own enclosure.',
'That they would be as quiet and contented here as elsewhere I was confident,',
'nor was there but the remotest possibility that they would be discovered, as the green men had no great desire to enter these outlying buildings, which were frequented by the only thing, I believe, which caused them the sensation of fear—the great white apes of Barsoom.',
...
'Waiting in the doorway of the building until I was assured that no one was approaching, I hurried across to the opposite side and through the first doorway to the court beyond;',
'thus, crossing through court after court with only the slight chance of detection which the necessary crossing of the avenues entailed, I made my way in safety to the courtyard in the rear of Dejah Thoris’ quarters.',
'Here, of course, I found the beasts of the warriors who quartered in the adjacent buildings, and the warriors themselves I might expect to meet within if I entered;',
'but, fortunately for me, I had another and safer method of reaching the upper story where Dejah Thoris should be found, and, after first determining as nearly as possible which of the buildings she occupied,',
'for I had never observed them before from the court side, I took advantage of my relatively great strength and agility and sprang upward until I grasped the sill of a second-story window which I thought to be in the rear of her apartment.',
...
'It was well indeed that I took this precaution, for the conversation I heard was in the low gutturals of men, and the words which finally came to me proved a most timely warning.',
...
'It will require the combined strength of all of you to do it if the reports they bring back from Korad are correct.',
...
'She was indeed the proud daughter of a thousand jeddaks, every inch of her dear, precious little body;',
'so small, so frail beside the towering warriors around her, but in her majesty dwarfing them into insignificance;',
...
'He was thinking of that other woman who, forty years ago, had stood before this beast, and could I have spoken a word into his ear at that moment the reign of Tal Hajus would have been over;',
'but finally he also strode from the room, not knowing that he left his own daughter at the mercy of the creature he most loathed.',
'Tal Hajus arose, and I, half fearing, half anticipating his intentions, hurried to the winding runway which led to the floors below.',
...
'“Princess of Helium, I might wring a mighty ransom from your people would I but return you to them unharmed, but a thousand times rather would I watch that beautiful face writhe in the agony of torture;',
'it shall be long drawn out, that I promise you;',
'ten days of pleasure were all too short to show the love I harbor for your race.',
...
'But before the torture you shall be mine for one short hour, and word of that too shall go forth to Tardos Mors, Jeddak of Helium, your grandfather, that he may grovel upon the ground in the agony of his sorrow.',
...
'My short-sword, sharp and gleaming was in my right hand;',
'I could have plunged it into his putrid heart before he realized that I was upon him;',
'but as I raised my arm to strike I thought of Tars Tarkas, and, with all my rage, with all my hatred, I could not rob him of that sweet moment for which he had lived and hoped all these long, weary years, and so, instead, I swung my good right fist full upon the point of his jaw.',
...
'Dropping lightly after them I drew them rapidly around the court in the shadows of the buildings, and thus we returned over the same course I had so recently followed from the distant boundary of the city.',
...
'Instead of circling back around the city to the northwest and toward the nearest waterway which lay so short a distance from us, we turned to the northeast and struck out upon the mossy waste across which,',
'for two hundred dangerous and weary miles, lay another main artery leading to Helium.',
...
'For my part I could not be other than joyful had I tried, with Dejah Thoris’ warm body pressed close to mine, and with all our unpassed danger my heart was singing as gaily as though we were already entering the gates of Helium.',
...
'Quickly lifting Dejah Thoris from the thoat, I commanded the animal to lie down and we three did the same, presenting as small an object as possible for fear of attracting the attention of the warriors toward us.',
...
'and, as a last resort, as an escape for themselves from the horrid death which recapture would surely mean, I lifted Dejah Thoris in my arms and placed her upon the thoat behind Sola, who had already mounted at my command.',
...
'She sprang quickly from the thoat and, throwing her dear arms about my neck, turned to Sola, saying with quiet dignity: “Fly, Sola!',
'Dejah Thoris remains to die with the man she loves.”',
'Those words are engraved upon my heart.',
'Ah, gladly would I give up my life a thousand times could I only hear them once again;',
'but I could not then give even a second to the rapture of her sweet embrace,',
'and pressing my lips to hers for the first time, I picked her up bodily and tossed her to her seat behind Sola again, commanding the latter in peremptory tones to hold her there by force,',
'and then, slapping the thoat upon the flank, I saw them borne away;',
'Dejah Thoris struggling to the last to free herself from Sola’s grasp.',
...
'and also decorated with the breastplate of human skulls and dried dead hands which seemed to mark all the greater warriors among the Warhoons, as well as to indicate their awful ferocity, which greatly transcends even that of the Tharks.',
...
'It was the one little opening that Dak Kova needed,',
'and hurling himself at the body of his adversary he buried his single mighty tusk in Bar Comas’ groin and with a last powerful effort ripped the young jeddak wide open the full length of his body, the great tusk finally wedging in the bones of Bar Comas’ jaw.',
...
'and the entire body of warriors, ten thousand in number, turned back toward Warhoon.',
...
'Not a day passed but that some members of the various Warhoon communities met in deadly combat.',
...
'The touch of my fingers on these keys brought back my reason with the suddenness of thought.',
...
'Then the truth flashed on me;',
'the owners of those gleaming eyes had dragged my prize away from me to be devoured in their neighboring lair;',
'as they had been waiting for days, for weeks, for months, through all this awful eternity of my imprisonment to drag my dead carcass to their feast.',
...
'As their retreating footsteps died away in the distance, I called out softly the Martian word of greeting, kaor.',
...
'And then I told him my story as I have written it here, omitting only any reference to my love for Dejah Thoris.',
...
'but while passing near the city of Zodanga, the capital of Helium’s hereditary enemies among the red men of Barsoom, they had been attacked by a great body of war vessels and all but the craft to which Kantos Kan belonged were either destroyed or captured.',
...
'Two green Martian communities had been wiped off the face of Barsoom by the avenging fleets, but no trace of Dejah Thoris had been found.',
'They had been searching among the northern hordes, and only within the past few days had they extended their quest to the south.',
...
'Around it the Warhoons had piled building stone from some of the ruined edifices of the ancient city to prevent the animals and the captives from escaping into the audience,',
'and at each end had been constructed cages to hold them until their turns came to meet some horrible death upon the arena.',
...
'As they advanced to meet one another I saw for the first time a trick of Martian swordsmanship which centered Kantos Kan’s every hope of victory and life on one cast of the dice,',
'for, as he came to within about twenty feet of the huge fellow he threw his sword arm far behind him over his shoulder and with a mighty sweep hurled his weapon point foremost at the green warrior.',
...
'Kantos Kan perceived my coup and stepping quickly to my side he placed his foot upon my neck and withdrawing his sword from my body gave me the final death blow through the neck which is supposed to sever the jugular vein,',
'but in this instance the cold blade slipped harmlessly into the sand of the arena.',
'In the darkness which had now fallen none could tell but that he had really finished me.',
'I whispered to him to go and claim his freedom and then look for me in the hills east of the city, and so he left me.',
...
'Without sound we lay there, the beast exerting every effort to reach me with those awful fangs, and I straining to maintain my grip and choke the life from it as I kept it from my throat.',
...
'By the light of the now brilliant moons I saw that he was but a shadow of his former self, and as he turned from my caress and commenced greedily to devour the dead carcass at my feet I realized that the poor fellow was more than half starved.',
...
'I could find no bell or other method of making my presence known to the inmates of the place, unless a small round hole in the wall near the door was for that purpose.',
...
'“You wear the metal of a green warrior and are followed by a calot, yet you are of the figure of a red man.',
'In color you are neither green nor red.',
'In the name of the ninth ray, what manner of creature are you?”',
'“I am a friend of the red men of Barsoom and I am starving.',
'In the name of humanity open to us,” I replied.',
'Presently the door commenced to recede before me until it had sunk into the wall fifty feet,',
'then it stopped and slid easily to the left, exposing a short, narrow corridor of concrete, at the further end of which was another door, similar in every respect to the one I had just passed.',
...
'He wore but a single article of clothing or adornment, a small collar of gold from which depended upon his chest a great ornament as large as a dinner plate set solid with huge diamonds,',
'except for the exact center which was occupied by a strange stone, an inch in diameter, that scintillated nine different and distinct rays;',
'the seven colors of our earthly prism and two beautiful rays which, to me, were new and nameless.',
...
'I did not apprise him of my ability to sense his mental operations, and thus I learned a great deal which proved of immense value to me later and which I would never have known had he suspected my strange power,',
'for the Martians have such perfect control of their mental machinery that they are able to direct their thoughts with absolute precision.',
...
'This product is then treated electrically, or rather certain proportions of refined electric vibrations are incorporated with it,',
'and the result is then pumped to the five principal air centers of the planet where, as it is released, contact with the ether of space transforms it into atmosphere.',
...
'The buildings I had been hammering at in the early morning were occupied only by stock and farm produce, the house proper standing among a grove of enormous trees,',
'and, like all red-Martian homes, had been raised at night some forty or fifty feet from the ground on a large round metal shaft which slid up or down within a sleeve sunk in the ground,',
'and was operated by a tiny radium engine in the entrance hall of the building.',
...
'The brothers had supplied me with a reddish oil with which I anointed my entire body and one of them cut my hair, which had grown quite long, in the prevailing fashion of the time, square at the back and banged in front,',
'so that I could have passed anywhere upon Barsoom as a full-fledged red Martian.',
...
'While this information was in no way reassuring, neither was it at all conclusive proof of the death of Dejah Thoris,',
'and so I determined to make every effort possible to reach Helium as quickly as I could and carry to Tardos Mors such news of his granddaughter’s possible whereabouts as lay in my power.',
...
'Had nothing further than my own safety or pleasure been at stake no argument could have prevailed upon me to turn away the one creature upon Barsoom that had never failed in a demonstration of affection and loyalty;',
'but as I would willingly have offered my life in the service of her in search of whom I was about to challenge the unknown dangers of this, to me, mysterious city, I could not permit even Woola’s life to threaten the success of my venture, much less his momentary happiness,',
'for I doubted not he soon would forget me.',
...
'He paid not the slightest attention to me, but as he came abreast I recognized him, and turning I placed my hand upon his shoulder, calling out:',
'“Kaor, Kantos Kan!”',
...
'“Were my name and city known to the Zodangans I would shortly be sitting on the banks of the lost sea of Korus with my revered and departed ancestors.',
...
'His father, Than Kosis, Jeddak of Zodanga, has made her voluntary marriage to his son the price of peace between our countries,',
'but Tardos Mors will not accede to the demands and has sent word that he and his people would rather look upon the dead face of their princess than see her wed to any than her own choice,',
'and that personally he would prefer being engulfed in the ashes of a lost and burning Helium to joining the metal of his house with that of Than Kosis.',
...
'“I have been here three days,” continued Kantos Kan, “but I have not yet found where Dejah Thoris is imprisoned.',
...
'In accordance with custom an examination was necessary, but Kantos Kan had told me to have no fear on this score as he would attend to that part of the matter.',
...
'The solar eighth ray would be absorbed by the surface of Barsoom,',
'but the Barsoomian eighth ray, which tends to propel light from Mars into space, is constantly streaming out from the planet constituting a force of repulsion of gravity which when confined is able to lift enormous weights from the surface of the ground.',
...
'During the early years of the discovery of this ray many strange accidents occurred before the Martians learned to measure and control the wonderful power they had found.',
...
'Her power of repulsion for the planet was so great that it had carried her far into space, where she can be seen today, by the aid of powerful telescopes, hurtling through the heavens ten thousand miles from Mars;',
...
'He was wounded and down with the huge foot of his antagonist upon his throat and the great long-sword raised to deal the final thrust.',
...
'and their trappings and ornamentation bore such a quantity of gorgeously colored feathers that I could not but be struck with the startling resemblance the concourse bore to a band of the red Indians of my own Earth.',
...
'As they approached Than Kosis the soldiers fell to either side and there standing before the jeddak and not ten feet from me, her beautiful face radiant with smiles, was Dejah Thoris.',
...
'Two days ago I was not sure of his love for me, but now I am, and I have come to beg of you to forget my rash words and to accept the assurance of the Princess of Helium that when the time comes she will wed Sab Than, Prince of Zodanga.”',
...
'“We shall see,” replied Than Kosis, “how the people of Helium take to peace.',
...
'Thus was the edifice of my brief dream of happiness dashed, broken, to the ground of reality.',
'The woman for whom I had offered my life, and from whose lips I had so recently heard a declaration of love for me, had lightly forgotten my very existence and smilingly given herself to the son of her people’s most hated enemy.',
...
'“I cannot repeat them now for I have given myself to another.',
'Ah, if you had only known our ways, my friend,” she continued, half to herself, “the promise would have been yours long months ago, and you could have claimed me before all others.',
'It might have meant the fall of Helium, but I would have given my empire for my Tharkian chief.”',
...
'You did not know, and I should not have been offended; I see that now.',
'But there was no one to tell you what I could not, that upon Barsoom there are two kinds of women in the cities of the red men.',
'The one they fight for that they may ask them in marriage; the other kind they fight for also, but never ask their hands.',
'When a man has won a woman he may address her as his princess, or in any of the several terms which signify possession.',
'You had fought for me, but had never asked me in marriage,',
'and so when you called me your princess, you see,” she faltered, “I was hurt, but even then, John Carter, I did not repulse you, as I should have done, until you made it doubly worse by taunting me with having won me through combat.”',
...
'I knew that my only hope lay in escape from the city of Zodanga,',
'for the matter of the four dead guardsmen would have to be explained, and as I could never reach my original post without a guide, suspicion would surely rest on me so soon as I was discovered wandering aimlessly through the palace.',
...
'Now, I knew, my troubles would commence in earnest and indeed they were upon me all too soon,',
'for it seemed that the squad had scarcely left the guardroom before one of their number burst in again breathlessly, crying that they had found their four comrades butchered in the antechamber.',
...
'for as a number of soldiers came hurrying past my hiding place I fell in behind them and followed through the mazes of the palace until, in passing through a great hall, I saw the blessed light of day coming in through a series of larger windows.',
...
'The news that Dejah Thoris had promised her hand to Sab Than filled him with dismay.',
...
'You, who do not know how we of Helium love the members of our ruling house, cannot appreciate the horror with which I contemplate such an unholy alliance.”',
'“What can be done, John Carter?” he continued.',
'“You are a resourceful man.',
'Can you not think of some way to save Helium from this disgrace?”',
...
'“And had the choice been left to me I could not have chosen a more fitting mate for the first princess of Barsoom.',
...
'In this work it is required that we investigate any unusual occurrence we may witness, and a face peering from the pinnacle of the high tower of the palace was, to me, most unusual.',
'I therefore drew near and discovered that the possessor of the peering face was none other than Sab Than.',
'He was slightly put out at being detected and commanded me to keep the matter to myself, explaining that the passage from the tower led directly to his apartments, and was known only to him.',
...
'But few buildings in Zodanga were higher than these barracks, though several topped it by a few hundred feet;',
'the docks of the great battleships of the line standing some fifteen hundred feet from the ground, while the freight and passenger stations of the merchant squadrons rose nearly as high.',
...
'Clinging to the wall with my feet and one hand, I unloosened one of the long leather straps of my trappings at the end of which dangled a great hook by which air sailors are hung to the sides and bottoms of their craft for various purposes of repair,',
...
'By twisting and turning my little machine, now rising and now falling, I managed to elude their search-lights most of the time, but I was also losing ground by these tactics,',
'and so I decided to hazard everything on a straight-away course and leave the result to fate and the speed of my machine.',
...
'As I sped through the air the screeching of the bullets around me convinced me that only by a miracle could I escape, but the die was cast, and throwing on full speed I raced a straight course toward Helium.',
...
'It was true I could follow the stars in the general direction of Helium, but without knowing the exact location of the city or the speed at which I was traveling my chances for finding it were slim.',
...
'for the Warhoons were closing in about us, and together we fought, shoulder to shoulder, during all that long, hot afternoon, until the tide of battle turned and the remnant of the fierce Warhoon horde fell back upon their thoats, and fled into the gathering darkness.',
...
'As I sat awaiting the return of the green warrior I heard something move in an adjoining apartment, and as I glanced up there rushed suddenly upon me a huge and hideous creature which bore me backward upon the pile of silks and furs upon which I had been reclining.',
...
'He no longer demurred when I suggested that we go before Tal Hajus, only saying that he would like to speak to Sarkoja first.',
...
'Having heard that he would do this on the morrow, I thought it only right to warn you, for I am a just man.',
...
'“We shall see who it is dares strike the mighty Tal Hajus.',
...
'We wait it.”',
'And still Tal Hajus stood as though petrified.',
...
'I told Tars Tarkas the story of my adventures, and in a few words had explained to him the thought I had in mind.',
'“John Carter has made a proposal,” he said, addressing the council, “which meets with my sanction.',
'I shall put it to you briefly.',
...
'The loot of Zodanga would be magnificent,',
'and I have often thought that had we an alliance with the people of Helium we could obtain sufficient assurance of sustenance to permit us to increase the size and frequency of our hatchings,',
'and thus become unquestionably supreme among the green men of all Barsoom.',
'What say you?”',
...
'and especially for the Zodangans, who had for years waged a ruthless campaign of extermination against the green men, directing special attention toward despoiling their incubators.',
'Now that we were before Zodanga the task of obtaining entry to the city devolved upon me,',
'and directing Tars Tarkas to hold his forces in two divisions out of earshot of the city, with each division opposite a large gateway, I took twenty dismounted warriors and approached one of the small gates that pierced the walls at short intervals.',
...
'As the great gate where I stood swung open my fifty Tharks, headed by Tars Tarkas himself, rode in upon their mighty thoats.',
...
'When the balance of the procession had entered and assumed their stations Than Kosis addressed the couple standing before him.',
'I could not hear his words, but presently two officers advanced and removed the scarlet robe from one of the figures, and I saw that Kantos Kan had failed in his mission, for it was Sab Than, Prince of Zodanga, who stood revealed before me.',
...
'After a few more words addressed to Sab Than he turned to the other figure, from which the officers now removed the enshrouding silks, disclosing to my now comprehending view Dejah Thoris, Princess of Helium.',
...
'It was an impressive and beautiful ceremony, I presume, but to me it seemed the most fiendish sight I had ever witnessed,',
'and as the ornaments were adjusted upon her beautiful figure and her collar of gold swung open in the hands of Than Kosis I raised my long-sword above my head,',
'and, with the heavy hilt, I shattered the glass of the great window and sprang into the midst of the astonished assemblage.',
...
'I could have killed him as easily as I might a fly, but the age-old custom of Barsoom stayed my hand, and grasping his wrist as the dagger flew toward my heart I held him as though in a vise and with my long-sword pointed to the far end of the hall.',
...
'Kill her!',
'Kill her!”',
'Calling to Dejah Thoris to get behind me I worked my way toward the little doorway back of the throne, but the officers realized my intentions,',
...
'Alone, a stranger, hunted, threatened, persecuted, you have done in a few short months what in all the past ages of Barsoom no man has ever done: joined together the wild hordes of the sea bottoms and brought them to fight as allies of a red Martian people.”',
...
'with death and destruction reaping their terrible harvest around her, did Dejah Thoris, Princess of Helium, true daughter of Mars, the God of War, promise herself in marriage to John Carter, Gentleman of Virginia.',
...
'Presently a great hole was torn in the hull of one of the immense battle craft from the Zodangan camp;',
'with a lurch she turned completely over, the little figures of her crew plunging, turning and twisting toward the ground a thousand feet below;',
...
'Though not a garrulous race, the Tharks are extremely formal, and their ways lend themselves amazingly to dignified and courtly manners.',
'Dejah Thoris went aboard the flagship, and was much put out that I would not follow, but, as I explained to her, the battle was but partly won;',
'we still had the land forces of the besieging Zodangans to account for, and I would not leave Tars Tarkas until that had been accomplished.',
'The commander of the naval forces of Helium promised to arrange to have the armies of Helium attack from the city in conjunction with our land attack,',
'and so the vessels separated and Dejah Thoris was borne in triumph back to the court of her grandfather, Tardos Mors, Jeddak of Helium.',
...
'That my poor services to Dejah Thoris had become known to the Heliumites was evidenced by the loud crying of my name, and by the loads of ornaments that were fastened upon me and my huge thoat as we passed up the avenues to the palace,',
'for even in the face of the ferocious appearance of Woola the populace pressed close about me.',
'As we approached this magnificent pile we were met by a party of officers who greeted us warmly and requested that Tars Tarkas and his jeds with the jeddaks and jeds of his wild allies,',
'together with myself, dismount and accompany them to receive from Tardos Mors an expression of his gratitude for our services.',
...
'“Jeddak of Helium,” returned Tars Tarkas, “it has remained for a man of another world to teach the green warriors of Barsoom the meaning of friendship;',
'to him we owe the fact that the hordes of Thark can understand you;',
'that they can appreciate and reciprocate the sentiments so graciously expressed.”',
...
'He had followed close behind Tardos Mors and seemed even more affected by the meeting than had his father.',
...
'In common with all Helium he worshiped his daughter, nor could he think of what she had escaped without deep emotion.',
...
'When all were in their seats he turned toward us.',
...
'We conversed in low tones, when we conversed at all, as the awe of the grim shadow of death crept over us.',
...
'“I love you!',
'I love you!',
'It is cruel that we must be torn apart who were just starting upon a life of love and happiness.”',
...
'“There is, there must be some way, and John Carter, who has fought his way through a strange world for love of you, will find it.”',
...
'That she had dropped into the last coma which would end in death, if the air supply remained unreplenished, I well knew,',
'and so, throwing caution to the winds, I flung overboard everything but the engine and compass, even to my ornaments,',
'and lying on my belly along the deck with one hand on the steering wheel and the other pushing the speed lever to its last notch I split the thin air of dying Mars with the speed of a meteor.',
...
'I can last but a few moments more.',
'But it is useless, they are both dead and no one else upon Barsoom knew the secret of these awful locks.',
...
'I could scarce believe my eyes, but the truth slowly forced itself upon me—I was looking upon Arizona from the same ledge from which ten years before I had gazed with longing upon Mars.',
...
'and tonight she seems calling to me again as she has not called before since that long dead night,',
'and I think I can see, across that awful abyss of space, a beautiful black-haired woman standing in the garden of a palace,',
'and at her side is a little boy who puts his arm around her as she points into the sky toward the planet Earth, while at their feet is a huge and hideous creature with a heart of gold.',
